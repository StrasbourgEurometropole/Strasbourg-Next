...
<!-- Section social wall-->
 <section id="smag-socials" class="smag-socials" data-scroll-animation>
    <div class="smag-container">
        <h2 class="waved-title waved-title--center waved-title--t-core waved-title--w-grey smag-socials__title">
            <div>Suivez</div>
            <div>#Strasbourg</div>
        </h2>
        <div class="smag-filters">
            <button class="smag-social-filter smag-texted smag-actif" data-category="tous">
                <span class="smag-flexbox">
                    <span class="smag-btn-text">Tous</span>
                </span>
            </button>
            <button class="smag-social-filter smag-fb" data-category="facebook">
            ...
            <button class="smag-social-filter smag-twit" data-category="twitter">
            ...
            <button class="smag-social-filter smag-daily" data-category="dailymotion">
            ...
            <button class="smag-social-filter smag-insta" data-category="instagram">
        ...
        <div class="smag-slider-social-container">
            <div class="smag-slider-overflow">
                <div class="smag-slider">
                </div>
            </div>
            <div class="owl-nav">
                <button class="smag-owl-prev">
                    <span class="smag-picto"></span>
                </button>
                <button class="smag-owl-next">
                    <span class="smag-picto"></span>
                </button>
            </div>
        </div>
        ...
        <div id="smag-social-templates">
            <!--Template Social-->
            <div class="smag-item smag-__category__">
                <a href="__link__" class="smag-link" title="__category__">
                    <div class="smag-picture" style="background-image: url(__picture__)">
                    </div>
                    <div class="smag-text">
                        <div class="smag-content dotme" data-dot="7">__content__</div>
                        <div class="smag-text-bottom">
                            <div class="smag-category dotme"><span class="smag-picto-category"></span>__category__</div>
                            <div class="smag-date"><span class="smag-picto-date"></span>__date__</div>
                        </div>
                    </div>
                </a>
            </div>
