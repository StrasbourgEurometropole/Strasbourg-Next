...
public class CampaignEventStatusUtil {
	 ...
	 */
	public static Map<Serializable, CampaignEventStatus> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CampaignEventStatus> findByUuid(String uuid) {
	 ...
	 */
	public static List<CampaignEventStatus> findByUuid(
	 ...
	 */
	public static CampaignEventStatus findByUuid_First(
			String uuid,
			OrderByComparator<CampaignEventStatus> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchCampaignEventStatusException {
	 ...
	 */
	public static CampaignEventStatus fetchByUuid_First(
	 ...
	 * @throws NoSuchCampaignEventStatusException if a matching campaign event status could not be found
	 */
	public static CampaignEventStatus findByUuid_Last(
			String uuid,
			OrderByComparator<CampaignEventStatus> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchCampaignEventStatusException {
	 ...
	 */
	public static CampaignEventStatus fetchByUuid_Last(
		String uuid, OrderByComparator<CampaignEventStatus> orderByComparator) {
	 ...
	 */
	public static CampaignEventStatus[] findByUuid_PrevAndNext(
	...
	public static CampaignEventStatus[] findByCampaignEventId_PrevAndNext(
		...
		return getPersistence().findByCampaignEventId_PrevAndNext(
			statusId, campaignEventId, orderByComparator);
	}
	...
	public static void setPersistence(
		CampaignEventStatusPersistence persistence) {
