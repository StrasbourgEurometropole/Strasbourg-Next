...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.agenda.model.AgendaExport"
	}
)
@ProviderType
@Transactional(
...
public interface AgendaExportLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.agenda.service.impl.AgendaExportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agenda export local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgendaExportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AgendaExport copyAgendaExport(
			ServiceContext sc, AgendaExport agendaToCopy)
	 ...
	 */
	public List<AgendaExport> findByKeyword(
	 ...
	 */
	public AgendaExport updateAgendaExport(
			AgendaExport agendaExport, ServiceContext sc)
		throws PortalException;
	 ...
	 */
	public AgendaExport updateStatus(
