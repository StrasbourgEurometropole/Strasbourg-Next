...
/**
 * The persistence utility for the campaign service. This utility wraps <code>eu.strasbourg.service.agenda.service.persistence.impl.CampaignPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CampaignUtil {
	 ...
	 * @return the matching campaigns
	 */
	public static List<Campaign> findByTitle(String title) {
	 ...
	 * @return the range of matching campaigns
	 */
	public static List<Campaign> findByTitle(String title, int start, int end) {
	 ...
	 * @return the ordered range of matching campaigns
	 */
	public static List<Campaign> findByTitle(
	 ...
	 * @throws NoSuchCampaignException if a matching campaign could not be found
	 */
	public static Campaign findByTitle_First(
	 ...
	 * @return the first matching campaign, or <code>null</code> if a matching campaign could not be found
	 */
	public static Campaign fetchByTitle_First(
		String title, OrderByComparator<Campaign> orderByComparator) {
	 ...
	 * @throws NoSuchCampaignException if a matching campaign could not be found
	 */
	public static Campaign findByTitle_Last(
			String title, OrderByComparator<Campaign> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.NoSuchCampaignException {
	 ...
	 * @return the last matching campaign, or <code>null</code> if a matching campaign could not be found
	 */
	public static Campaign fetchByTitle_Last(
		String title, OrderByComparator<Campaign> orderByComparator) {
	 ...
	 * @throws NoSuchCampaignException if a campaign with the primary key could not be found
	 */
	public static Campaign[] findByTitle_PrevAndNext(
			long campaignId, String title,
			OrderByComparator<Campaign> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.NoSuchCampaignException {

		return getPersistence().findByTitle_PrevAndNext(
			campaignId, title, orderByComparator);
	}
	...
	public static void setPersistence(CampaignPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile CampaignPersistence _persistence;
