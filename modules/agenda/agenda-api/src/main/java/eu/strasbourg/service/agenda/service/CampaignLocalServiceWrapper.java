...
public class CampaignLocalServiceWrapper
	 ...
	 */
	@Override
	public eu.strasbourg.service.agenda.model.Campaign
	 ...
	 */
	@Override
	public java.util.List<eu.strasbourg.service.agenda.model.Campaign>
		findByKeyword(String keyword, long groupId, int start, int end) {

		return _campaignLocalService.findByKeyword(
	...
	public BasePersistence<?> getBasePersistence() {
		return _campaignLocalService.getBasePersistence();
	}
