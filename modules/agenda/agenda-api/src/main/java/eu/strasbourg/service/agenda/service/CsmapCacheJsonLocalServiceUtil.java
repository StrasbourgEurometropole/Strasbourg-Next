...
public class CsmapCacheJsonLocalServiceUtil {
	 ...
	 */
	public static CsmapCacheJson createCsmapCacheJson(long eventId) {
	 ...
	 */
	public static CsmapCacheJson deleteCsmapCacheJson(long eventId)
		throws PortalException {
	...
	public static CsmapCacheJson fetchCsmapCacheJson(long eventId) {
	 ...
	 * @throws PortalException if a csmap cache json with the primary key could not be found
	 */
	public static CsmapCacheJson getCsmapCacheJson(long eventId)
		throws PortalException {
