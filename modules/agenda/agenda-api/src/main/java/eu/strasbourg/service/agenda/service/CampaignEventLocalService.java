...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.agenda.model.CampaignEvent"
	}
)
@ProviderType
@Transactional(
...
public interface CampaignEventLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.agenda.service.impl.CampaignEventLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the campaign event local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CampaignEventLocalServiceUtil} if injection and service tracking are not available.
	 */
