 ...
 */
@ProviderType
public interface AgendaExportPeriodPersistence
	extends BasePersistence<AgendaExportPeriod> {
	 ...
	 */
	public java.util.List<AgendaExportPeriod> findByUuid(String uuid);
	...
	public java.util.List<AgendaExportPeriod> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AgendaExportPeriod>
			orderByComparator);
