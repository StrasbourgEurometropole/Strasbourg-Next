...
/**
 * The persistence utility for the import report line service. This utility wraps <code>eu.strasbourg.service.agenda.service.persistence.impl.ImportReportLinePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ImportReportLineUtil {
	 ...
	 */
	public static Map<Serializable, ImportReportLine> fetchByPrimaryKeys(
	 ...
	 */
	public static ImportReportLine update(
		ImportReportLine importReportLine, ServiceContext serviceContext) {
	 ...
	 */
	public static List<ImportReportLine> findByUuid(String uuid) {
	 ...
	 */
	public static List<ImportReportLine> findByUuid(
	 ...
	 */
	public static ImportReportLine fetchByUuid_First(
		String uuid, OrderByComparator<ImportReportLine> orderByComparator) {
	 ...
	 * @throws NoSuchImportReportLineException if a matching import report line could not be found
	 */
	public static ImportReportLine findByUuid_Last(
			String uuid, OrderByComparator<ImportReportLine> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchImportReportLineException {
	 ...
	 */
	public static ImportReportLine fetchByUuid_Last(
		String uuid, OrderByComparator<ImportReportLine> orderByComparator) {
	 ...
	 */
	public static ImportReportLine[] findByUuid_PrevAndNext(
	...
	public static ImportReportLine[] findByTypeAndStatus_PrevAndNext(
		...
		return getPersistence().findByTypeAndStatus_PrevAndNext(
			lineId, type, status, orderByComparator);
	}
	 ...
	 * @param status the status
	 */
	public static void removeByTypeAndStatus(String type, long status) {
	 ...
	 * @return the number of matching import report lines
	 */
	public static int countByTypeAndStatus(String type, long status) {
	 ...
	 * @return the range of matching import report lines
	 */
	public static List<ImportReportLine> findByReportId(
	...
	public static List<ImportReportLine> findByReportId(
		...
		return getPersistence().findByReportId(
			reportId, start, end, orderByComparator);
	}
	...
	public static List<ImportReportLine> findByReportId(
		...
		return getPersistence().findByReportId(
			reportId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchImportReportLineException if a matching import report line could not be found
	 */
	public static ImportReportLine findByReportId_First(
			long reportId,
			OrderByComparator<ImportReportLine> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchImportReportLineException {

		return getPersistence().findByReportId_First(
	 ...
	 * @return the first matching import report line, or <code>null</code> if a matching import report line could not be found
	 */
	public static ImportReportLine fetchByReportId_First(
		long reportId, OrderByComparator<ImportReportLine> orderByComparator) {

		return getPersistence().fetchByReportId_First(
			reportId, orderByComparator);
	}
	 ...
	 * @throws NoSuchImportReportLineException if a matching import report line could not be found
	 */
	public static ImportReportLine findByReportId_Last(
			long reportId,
			OrderByComparator<ImportReportLine> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchImportReportLineException {

		return getPersistence().findByReportId_Last(
			reportId, orderByComparator);
	}
	 ...
	 * @return the last matching import report line, or <code>null</code> if a matching import report line could not be found
	 */
	public static ImportReportLine fetchByReportId_Last(
		long reportId, OrderByComparator<ImportReportLine> orderByComparator) {

		return getPersistence().fetchByReportId_Last(
			reportId, orderByComparator);
	}
	 ...
	 * @throws NoSuchImportReportLineException if a import report line with the primary key could not be found
	 */
	public static ImportReportLine[] findByReportId_PrevAndNext(
			long lineId, long reportId,
			OrderByComparator<ImportReportLine> orderByComparator)
		throws eu.strasbourg.service.agenda.exception.
			NoSuchImportReportLineException {

		return getPersistence().findByReportId_PrevAndNext(
			lineId, reportId, orderByComparator);
	}
	...
	public static ImportReportLine updateImpl(
	...
	public static void setPersistence(ImportReportLinePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile ImportReportLinePersistence _persistence;
