 ...
 */
@OSGiBeanProperties(
	property = {"model.class.name=eu.strasbourg.service.agenda.model.Historic"}
)
@ProviderType
@Transactional(
...
public interface HistoricLocalService
	...
	public Historic createHistoric(long eventId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Historic deleteHistoric(long eventId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Historic fetchHistoric(long eventId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Historic getHistoric(long eventId) throws PortalException;
