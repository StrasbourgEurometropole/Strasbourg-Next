...
@OSGiBeanProperties(
	property = {
		...
		"json.web.service.context.path=EventPeriod"
	},
	service = EventPeriodService.class
)
@ProviderType
@Transactional(
...
public interface EventPeriodService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.agenda.service.impl.EventPeriodServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the event period remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EventPeriodServiceUtil} if injection and service tracking are not available.
	 */
