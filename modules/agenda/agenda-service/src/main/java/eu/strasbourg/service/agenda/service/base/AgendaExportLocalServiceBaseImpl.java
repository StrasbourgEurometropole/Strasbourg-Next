...
/**
 * Provides the base implementation for the agenda export local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.agenda.service.impl.AgendaExportLocalServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 ...
 * @generated
 */
public abstract class AgendaExportLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AgendaExportLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgendaExportLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AgendaExportLocalServiceUtil</code>.
	 */
	...
	public AgendaExport addAgendaExport(AgendaExport agendaExport) {
		...
		return agendaExportPersistence.update(agendaExport);
	}
	...
	public AgendaExport createAgendaExport(long agendaExportId) {
		return agendaExportPersistence.create(agendaExportId);
	}
	...
	public AgendaExport deleteAgendaExport(long agendaExportId)
		...
		return agendaExportPersistence.remove(agendaExportId);
	}
	...
	public AgendaExport deleteAgendaExport(AgendaExport agendaExport) {
		return agendaExportPersistence.remove(agendaExport);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return agendaExportPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AgendaExport.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return agendaExportPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return agendaExportPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AgendaExport fetchAgendaExport(long agendaExportId) {
		return agendaExportPersistence.fetchByPrimaryKey(agendaExportId);
	}
	...
	public AgendaExport fetchAgendaExportByUuidAndGroupId(
		...
		return agendaExportPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AgendaExport getAgendaExport(long agendaExportId)
		...
		return agendaExportPersistence.findByPrimaryKey(agendaExportId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(agendaExportLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AgendaExport.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("agendaExportId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AgendaExport.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AgendaExport>() {
				...
				@Override
				public void performAction(AgendaExport agendaExport)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, agendaExport);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return agendaExportPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AgendaExportLocalServiceImpl#deleteAgendaExport(AgendaExport) to avoid orphaned data");
		}

		return agendaExportLocalService.deleteAgendaExport(
			(AgendaExport)persistedModel);
	}

	@Override
	public BasePersistence<AgendaExport> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return agendaExportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AgendaExport> getAgendaExportsByUuidAndCompanyId(
		...
		return agendaExportPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AgendaExport> getAgendaExportsByUuidAndCompanyId(
		...
		return agendaExportPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public AgendaExport getAgendaExportByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return agendaExportPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AgendaExport> getAgendaExports(int start, int end) {
		return agendaExportPersistence.findAll(start, end);
	}
	...
	public int getAgendaExportsCount() {
		return agendaExportPersistence.countAll();
	}
	 ...
	 */
	public AgendaExportLocalService getAgendaExportLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(agendaExportLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgendaExportLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = agendaExportPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AgendaExportLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, agendaExportLocalService);
		}
	...
	@BeanReference(type = AgendaExportLocalService.class)
	protected AgendaExportLocalService agendaExportLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgendaExportLocalServiceBaseImpl.class);
