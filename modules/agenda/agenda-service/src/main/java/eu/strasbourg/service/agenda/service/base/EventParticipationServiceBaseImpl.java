...
import eu.strasbourg.service.agenda.service.EventParticipationService;
...
/**
 * Provides the base implementation for the event participation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.agenda.service.impl.EventParticipationServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 ...
 * @generated
 */
public abstract class EventParticipationServiceBaseImpl
	extends BaseServiceImpl
	implements EventParticipationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventParticipationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EventParticipationServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(eventParticipationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventParticipationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = EventParticipationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, eventParticipationService);
		}
	...
	@BeanReference(type = EventParticipationService.class)
	protected EventParticipationService eventParticipationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EventParticipationServiceBaseImpl.class);
