...
public abstract class EventParticipationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventParticipationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EventParticipationLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return eventParticipationPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return eventParticipationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EventParticipationLocalServiceImpl#deleteEventParticipation(EventParticipation) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<EventParticipation> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(eventParticipationLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EventParticipationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, eventParticipationLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EventParticipationLocalServiceBaseImpl.class);
