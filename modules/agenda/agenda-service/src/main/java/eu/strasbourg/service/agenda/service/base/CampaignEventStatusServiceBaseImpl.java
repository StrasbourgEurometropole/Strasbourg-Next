...
/**
 * Provides the base implementation for the campaign event status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.agenda.service.impl.CampaignEventStatusServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
...
public abstract class CampaignEventStatusServiceBaseImpl
	 ...
	 */
	public CampaignEventStatusService getCampaignEventStatusService() {
	...
	public void afterPropertiesSet() {
		CampaignEventStatusServiceUtil.setService(campaignEventStatusService);
	}

	public void destroy() {
		CampaignEventStatusServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CampaignEventStatusService.class.getName();
	}
