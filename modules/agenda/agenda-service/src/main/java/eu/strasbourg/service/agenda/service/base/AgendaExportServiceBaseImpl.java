...
/**
 * Provides the base implementation for the agenda export remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.agenda.service.impl.AgendaExportServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 ...
 * @generated
 */
public abstract class AgendaExportServiceBaseImpl
	extends BaseServiceImpl
	implements AgendaExportService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgendaExportService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AgendaExportServiceUtil</code>.
	 */
	 ...
	 */
	public AgendaExportService getAgendaExportService() {
	...
	public void setAgendaExportService(
		AgendaExportService agendaExportService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(agendaExportService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgendaExportService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = AgendaExportServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, agendaExportService);
		}
	...
	@BeanReference(type = AgendaExportService.class)
	protected AgendaExportService agendaExportService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgendaExportServiceBaseImpl.class);
