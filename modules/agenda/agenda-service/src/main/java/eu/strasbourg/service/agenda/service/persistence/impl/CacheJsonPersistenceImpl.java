...
public class CacheJsonPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setCacheJsonUtilPersistence(this);
	}

	public void destroy() {
		_setCacheJsonUtilPersistence(null);

		entityCache.removeCache(CacheJsonImpl.class.getName());
	}

	private void _setCacheJsonUtilPersistence(
		CacheJsonPersistence cacheJsonPersistence) {

		try {
			Field field = CacheJsonUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, cacheJsonPersistence);
		}
