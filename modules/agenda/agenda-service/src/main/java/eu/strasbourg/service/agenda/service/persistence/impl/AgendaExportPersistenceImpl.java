...
public class AgendaExportPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setAgendaExportUtilPersistence(this);
	}

	public void destroy() {
		_setAgendaExportUtilPersistence(null);

		entityCache.removeCache(AgendaExportImpl.class.getName());
	}

	private void _setAgendaExportUtilPersistence(
		AgendaExportPersistence agendaExportPersistence) {

		try {
			Field field = AgendaExportUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, agendaExportPersistence);
		}
