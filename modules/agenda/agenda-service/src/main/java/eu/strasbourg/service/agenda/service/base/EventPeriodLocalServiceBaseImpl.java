...
public abstract class EventPeriodLocalServiceBaseImpl
	...
	implements EventPeriodLocalService, IdentifiableOSGiService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EventPeriod.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return eventPeriodPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return eventPeriodPersistence.countWithDynamicQuery(
	...
	public void afterPropertiesSet() {
		EventPeriodLocalServiceUtil.setService(eventPeriodLocalService);
	}

	public void destroy() {
		EventPeriodLocalServiceUtil.setService(null);
	}
