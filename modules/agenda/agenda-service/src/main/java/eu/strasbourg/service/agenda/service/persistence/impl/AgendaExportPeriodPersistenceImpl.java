...
public class AgendaExportPeriodPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setAgendaExportPeriodUtilPersistence(this);
	}

	public void destroy() {
		_setAgendaExportPeriodUtilPersistence(null);

		entityCache.removeCache(AgendaExportPeriodImpl.class.getName());
	}

	private void _setAgendaExportPeriodUtilPersistence(
		AgendaExportPeriodPersistence agendaExportPeriodPersistence) {

		try {
			Field field = AgendaExportPeriodUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, agendaExportPeriodPersistence);
		}
