...
public abstract class CampaignEventStatusLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CampaignEventStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CampaignEventStatusLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return campaignEventStatusPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CampaignEventStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return campaignEventStatusPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return campaignEventStatusPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return campaignEventStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CampaignEventStatusLocalServiceImpl#deleteCampaignEventStatus(CampaignEventStatus) to avoid orphaned data");
		}

		return campaignEventStatusLocalService.deleteCampaignEventStatus(
	 ...
	 */
	public CampaignEventStatusLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(campaignEventStatusLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				CampaignEventStatusLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, campaignEventStatusLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CampaignEventStatusLocalServiceBaseImpl.class);
