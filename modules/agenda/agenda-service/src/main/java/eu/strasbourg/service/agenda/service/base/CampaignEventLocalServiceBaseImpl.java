...
public abstract class CampaignEventLocalServiceBaseImpl
	...
	implements CampaignEventLocalService, IdentifiableOSGiService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CampaignEvent.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return campaignEventPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return campaignEventPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<CampaignEvent>() {
				...
				public void performAction(CampaignEvent campaignEvent)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, campaignEvent);
				}
	...
	public List<CampaignEvent> getCampaignEventsByUuidAndCompanyId(
		...
		return campaignEventPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		CampaignEventLocalServiceUtil.setService(campaignEventLocalService);
	}

	public void destroy() {
		CampaignEventLocalServiceUtil.setService(null);
	}
