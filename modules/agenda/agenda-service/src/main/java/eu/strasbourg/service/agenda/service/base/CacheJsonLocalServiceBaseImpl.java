 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.agenda.service.impl.CacheJsonLocalServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 * @see eu.strasbourg.service.agenda.service.impl.CacheJsonLocalServiceImpl
 * @generated
 */
public abstract class CacheJsonLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CacheJsonLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CacheJsonLocalServiceUtil</code>.
	 */
	...
	public CacheJson createCacheJson(long eventId) {
		return cacheJsonPersistence.create(eventId);
	}
	...
	public CacheJson deleteCacheJson(long eventId) throws PortalException {
		return cacheJsonPersistence.remove(eventId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return cacheJsonPersistence.dslQuery(dslQuery);
	}
	...
	public CacheJson fetchCacheJson(long eventId) {
		return cacheJsonPersistence.fetchByPrimaryKey(eventId);
	}
	...
	public CacheJson getCacheJson(long eventId) throws PortalException {
		return cacheJsonPersistence.findByPrimaryKey(eventId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cacheJsonLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CacheJson.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CacheJson.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cacheJsonPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CacheJsonLocalServiceImpl#deleteCacheJson(CacheJson) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<CacheJson> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"eu.strasbourg.service.agenda.model.CacheJson",
			cacheJsonLocalService);

		_setLocalServiceUtilService(cacheJsonLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CacheJsonLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cacheJsonLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CacheJsonLocalServiceBaseImpl.class);
