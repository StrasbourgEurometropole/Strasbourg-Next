...
public class ImportReportLinePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setImportReportLineUtilPersistence(this);
	}

	public void destroy() {
		_setImportReportLineUtilPersistence(null);

		entityCache.removeCache(ImportReportLineImpl.class.getName());
	}

	private void _setImportReportLineUtilPersistence(
		ImportReportLinePersistence importReportLinePersistence) {

		try {
			Field field = ImportReportLineUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, importReportLinePersistence);
		}
