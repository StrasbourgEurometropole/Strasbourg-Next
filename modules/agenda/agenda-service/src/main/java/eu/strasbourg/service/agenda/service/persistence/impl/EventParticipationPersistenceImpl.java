...
public class EventParticipationPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setEventParticipationUtilPersistence(this);
	}

	public void destroy() {
		_setEventParticipationUtilPersistence(null);

		entityCache.removeCache(EventParticipationImpl.class.getName());
	}

	private void _setEventParticipationUtilPersistence(
		EventParticipationPersistence eventParticipationPersistence) {

		try {
			Field field = EventParticipationUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, eventParticipationPersistence);
		}
