...
public class OfficialUtil {
	 ...
	 * @return the matching official, or <code>null</code> if a matching official could not be found
	 */
	public static Official fetchByEmail(String email) {
	 ...
	 * @return the matching official, or <code>null</code> if a matching official could not be found
	 */
	public static Official fetchByEmail(String email, boolean useFinderCache) {
	 ...
	 * @return the official that was removed
	 */
	public static Official removeByEmail(String email)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialException {
	...
	public static List<Official> findByGroupIdAndIsActive(
		...
		return getPersistence().findByGroupIdAndIsActive(groupId, isActive);
	}
	...
	public static List<Official> findByGroupIdAndIsActive(
		...
		return getPersistence().findByGroupIdAndIsActive(
			groupId, isActive, start, end);
	}
	...
	public static List<Official> findByGroupIdAndIsActive(
		...
		return getPersistence().findByGroupIdAndIsActive(
			groupId, isActive, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchOfficialException if a matching official could not be found
	 */
	public static Official findByGroupIdAndIsActive_First(
			long groupId, boolean isActive,
			OrderByComparator<Official> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialException {

		return getPersistence().findByGroupIdAndIsActive_First(
	 ...
	 * @return the first matching official, or <code>null</code> if a matching official could not be found
	 */
	public static Official fetchByGroupIdAndIsActive_First(
		long groupId, boolean isActive,
		OrderByComparator<Official> orderByComparator) {

		return getPersistence().fetchByGroupIdAndIsActive_First(
			groupId, isActive, orderByComparator);
	}
	 ...
	 * @throws NoSuchOfficialException if a matching official could not be found
	 */
	public static Official findByGroupIdAndIsActive_Last(
			long groupId, boolean isActive,
			OrderByComparator<Official> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialException {

		return getPersistence().findByGroupIdAndIsActive_Last(
			groupId, isActive, orderByComparator);
	}
	 ...
	 * @return the last matching official, or <code>null</code> if a matching official could not be found
	 */
	public static Official fetchByGroupIdAndIsActive_Last(
		long groupId, boolean isActive,
		OrderByComparator<Official> orderByComparator) {

		return getPersistence().fetchByGroupIdAndIsActive_Last(
			groupId, isActive, orderByComparator);
	}
	 ...
	 * @throws NoSuchOfficialException if a official with the primary key could not be found
	 */
	public static Official[] findByGroupIdAndIsActive_PrevAndNext(
			long officialId, long groupId, boolean isActive,
			OrderByComparator<Official> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialException {

		return getPersistence().findByGroupIdAndIsActive_PrevAndNext(
			officialId, groupId, isActive, orderByComparator);
	}
	 ...
	 * @param isActive the is active
	 */
	public static void removeByGroupIdAndIsActive(
		long groupId, boolean isActive) {

		getPersistence().removeByGroupIdAndIsActive(groupId, isActive);
	}
	 ...
	 * @return the number of matching officials
	 */
	public static int countByGroupIdAndIsActive(
		long groupId, boolean isActive) {

		return getPersistence().countByGroupIdAndIsActive(groupId, isActive);
	}
