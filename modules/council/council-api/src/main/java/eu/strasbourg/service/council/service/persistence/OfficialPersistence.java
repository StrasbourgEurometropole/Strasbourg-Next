...
public interface OfficialPersistence extends BasePersistence<Official> {
	 ...
	 */
	public java.util.List<Official> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Official> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Official> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Official>
			orderByComparator);
	 ...
	 * @return the matching officials
	 */
	public java.util.List<Official> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching officials
	 */
	public java.util.List<Official> findByUuid_C(
	 ...
	 * @return the matching officials
	 */
	public java.util.List<Official> findByGroupIdAndIsActive(
