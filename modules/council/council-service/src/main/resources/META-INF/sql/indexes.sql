...
create index IX_7E0C3527 on council_Procuration (councilSessionId, officialUnavailableId, officialVotersId);
create index IX_13370DF3 on council_Procuration (councilSessionId, officialVotersId);
