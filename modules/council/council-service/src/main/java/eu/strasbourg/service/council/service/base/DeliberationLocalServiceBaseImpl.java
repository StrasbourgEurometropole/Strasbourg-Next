...
public abstract class DeliberationLocalServiceBaseImpl
	...
	implements DeliberationLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DeliberationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DeliberationLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return deliberationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Deliberation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return deliberationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return deliberationPersistence.countWithDynamicQuery(
			...
			new ActionableDynamicQuery.PerformActionMethod<Deliberation>() {
				...
				public void performAction(Deliberation deliberation)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, deliberation);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return deliberationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DeliberationLocalServiceImpl#deleteDeliberation(Deliberation) to avoid orphaned data");
		}

		return deliberationLocalService.deleteDeliberation(
			(Deliberation)persistedModel);
	}

	@Override
	public BasePersistence<Deliberation> getBasePersistence() {
	...
	public List<Deliberation> getDeliberationsByUuidAndCompanyId(
		...
		return deliberationPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(deliberationLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DeliberationLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, deliberationLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DeliberationLocalServiceBaseImpl.class);
