...
public class TypePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setTypeUtilPersistence(this);
	}

	public void destroy() {
		_setTypeUtilPersistence(null);

		dummyEntityCache.removeCache(TypeImpl.class.getName());
	}

	private void _setTypeUtilPersistence(TypePersistence typePersistence) {
		try {
			Field field = TypeUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, typePersistence);
		}
