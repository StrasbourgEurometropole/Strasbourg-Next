...
public abstract class CouncilSessionLocalServiceBaseImpl
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(councilSessionLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CouncilSessionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, councilSessionLocalService);
		}
