...
@OSGiBeanProperties(
	property = {
		"class.name=eu.strasbourg.service.council.model.impl.OfficialImpl",
		"table.name=council_Official"
	},
...
public class OfficialModelArgumentsResolver implements ArgumentsResolver {
	...
	static {
		...
		orderByColumnsBitmask |= OfficialModelImpl.getColumnBitmask("lastname");
