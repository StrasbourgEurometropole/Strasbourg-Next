 ...
 */
@ProviderType
public interface ArtworkCollectionPersistence
	extends BasePersistence<ArtworkCollection> {
	 ...
	 */
	public java.util.List<ArtworkCollection> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<ArtworkCollection> findByUuid(
	...
	public java.util.List<ArtworkCollection> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ArtworkCollection>
			orderByComparator);
	 ...
	 * @return the matching artwork collections
	 */
	public java.util.List<ArtworkCollection> findByGroupId(long groupId);
	 ...
	 * @return the range of matching artwork collections
	 */
	public java.util.List<ArtworkCollection> findByGroupId(
	 ...
	 */
	public java.util.List<eu.strasbourg.service.artwork.model.Artwork>
		getArtworks(long pk, int start, int end);
