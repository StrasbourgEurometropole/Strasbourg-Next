...
/**
 * The persistence utility for the artwork service. This utility wraps <code>eu.strasbourg.service.artwork.service.persistence.impl.ArtworkPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ArtworkUtil {
	 ...
	 */
	public static Map<Serializable, Artwork> fetchByPrimaryKeys(
	 ...
	 */
	public static Artwork update(
		Artwork artwork, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Artwork> findByUuid(String uuid) {
	 ...
	 */
	public static List<Artwork> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Artwork> findByUuid(
	 ...
	 */
	public static Artwork findByUuid_First(
	 ...
	 */
	public static Artwork fetchByUuid_First(
		String uuid, OrderByComparator<Artwork> orderByComparator) {
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByUuid_Last(
			String uuid, OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {
	 ...
	 */
	public static Artwork fetchByUuid_Last(
		String uuid, OrderByComparator<Artwork> orderByComparator) {
	 ...
	 */
	public static Artwork[] findByUuid_PrevAndNext(
			long artworkId, String uuid,
			OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {

		return getPersistence().findByUuid_PrevAndNext(
			artworkId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByUUID_G(String uuid, long groupId)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {
	 ...
	 */
	public static Artwork fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching artwork, or <code>null</code> if a matching artwork could not be found
	 */
	public static Artwork fetchByUUID_G(
	 ...
	 */
	public static Artwork removeByUUID_G(String uuid, long groupId)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {
	 ...
	 * @return the matching artworks
	 */
	public static List<Artwork> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching artworks
	 */
	public static List<Artwork> findByUuid_C(
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByUuid_C_First(
	 ...
	 * @return the first matching artwork, or <code>null</code> if a matching artwork could not be found
	 */
	public static Artwork fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Artwork> orderByComparator) {
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {
	 ...
	 * @return the last matching artwork, or <code>null</code> if a matching artwork could not be found
	 */
	public static Artwork fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Artwork> orderByComparator) {
	 ...
	 * @throws NoSuchArtworkException if a artwork with the primary key could not be found
	 */
	public static Artwork[] findByUuid_C_PrevAndNext(
			long artworkId, String uuid, long companyId,
			OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {

		return getPersistence().findByUuid_C_PrevAndNext(
			artworkId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the range of matching artworks
	 */
	public static List<Artwork> findByGroupId(
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByGroupId_First(
	 ...
	 * @return the first matching artwork, or <code>null</code> if a matching artwork could not be found
	 */
	public static Artwork fetchByGroupId_First(
		long groupId, OrderByComparator<Artwork> orderByComparator) {
	 ...
	 * @throws NoSuchArtworkException if a matching artwork could not be found
	 */
	public static Artwork findByGroupId_Last(
			long groupId, OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {
	 ...
	 * @return the last matching artwork, or <code>null</code> if a matching artwork could not be found
	 */
	public static Artwork fetchByGroupId_Last(
		long groupId, OrderByComparator<Artwork> orderByComparator) {
	 ...
	 * @throws NoSuchArtworkException if a artwork with the primary key could not be found
	 */
	public static Artwork[] findByGroupId_PrevAndNext(
			long artworkId, long groupId,
			OrderByComparator<Artwork> orderByComparator)
		throws eu.strasbourg.service.artwork.exception.NoSuchArtworkException {

		return getPersistence().findByGroupId_PrevAndNext(
			artworkId, groupId, orderByComparator);
	}
	 ...
	 */
	public static List<eu.strasbourg.service.artwork.model.ArtworkCollection>
	...
	public static List<eu.strasbourg.service.artwork.model.ArtworkCollection>
		...
		return getPersistence().getArtworkCollections(
	 ...
	 */
	public static boolean containsArtworkCollection(
		long pk, long artworkCollectionPK) {

		return getPersistence().containsArtworkCollection(
	 ...
	 * @param artworkCollectionPK the primary key of the artwork collection
	 */
	public static void removeArtworkCollection(
		long pk, long artworkCollectionPK) {
	 ...
	 * @param artworkCollectionPKs the primary keys of the artwork collections
	 */
	public static void removeArtworkCollections(
		long pk, long[] artworkCollectionPKs) {
	 ...
	 */
	public static void setArtworkCollections(
		long pk, long[] artworkCollectionPKs) {
