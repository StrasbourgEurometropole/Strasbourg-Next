...
import eu.strasbourg.service.artwork.service.ArtworkService;
import eu.strasbourg.service.artwork.service.ArtworkServiceUtil;
...
/**
 * Provides the base implementation for the artwork remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.artwork.service.impl.ArtworkServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 ...
 * @generated
 */
public abstract class ArtworkServiceBaseImpl
	extends BaseServiceImpl implements ArtworkService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ArtworkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ArtworkServiceUtil</code>.
	 */
	...
	/**
	 * Returns the artwork remote service.
	 *
	...
	/**
	 * Sets the artwork remote service.
	 *
	 * @param artworkService the artwork remote service
	 */
	...
	/**
	 * Returns the artwork collection remote service.
	 *
	 * @return the artwork collection remote service
	 */
	public eu.strasbourg.service.artwork.service.ArtworkCollectionService
		getArtworkCollectionService() {

		return artworkCollectionService;
	}

	/**
	 * Sets the artwork collection remote service.
	 *
	 * @param artworkCollectionService the artwork collection remote service
	 */
	public void setArtworkCollectionService(
		eu.strasbourg.service.artwork.service.ArtworkCollectionService
			artworkCollectionService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(artworkService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ArtworkService.class.getName();
	}
	...
	private void _setServiceUtilService(ArtworkService artworkService) {
		try {
			Field field = ArtworkServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, artworkService);
		}
	...
	@BeanReference(type = ArtworkService.class)
	...
	@BeanReference(
		type = eu.strasbourg.service.artwork.service.ArtworkCollectionService.class
	)
	protected eu.strasbourg.service.artwork.service.ArtworkCollectionService
		artworkCollectionService;
