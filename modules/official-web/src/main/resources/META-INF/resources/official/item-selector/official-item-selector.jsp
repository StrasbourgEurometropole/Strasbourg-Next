...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		<liferay-ui:search-container-row
			...
			modelVar="official" cssClass="official-row" keyProperty="officialId" rowIdProperty="officialId"
		>
			<liferay-ui:search-container-column-text cssClass="content-column"
				name="lastName" truncate="true"
				value="${official.lastName}" />
				
			<liferay-ui:search-container-column-text cssClass="content-column"
				name="firstName" truncate="true"
				value="${official.firstName}" />

			<fmt:formatDate value="${official.modifiedDate}"
			...
			<liferay-ui:search-container-column-text name="status">
				...
				<div class="data" data-id="${official.officialId}" data-title="${official.lastName} ${official.firstName}"></div>
...
<aui:script>
	$('.official-row input[type=checkbox]').on('change', function() {
