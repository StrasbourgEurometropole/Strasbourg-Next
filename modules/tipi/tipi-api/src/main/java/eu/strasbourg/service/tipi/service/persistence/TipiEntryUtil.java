...
/**
 * The persistence utility for the tipi entry service. This utility wraps <code>eu.strasbourg.service.tipi.service.persistence.impl.TipiEntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TipiEntryUtil {
	 ...
	 */
	public static Map<Serializable, TipiEntry> fetchByPrimaryKeys(
	 ...
	 */
	public static TipiEntry update(
		TipiEntry tipiEntry, ServiceContext serviceContext) {
	 ...
	 */
	public static List<TipiEntry> findByUuid(String uuid) {
	 ...
	 */
	public static List<TipiEntry> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<TipiEntry> findByUuid(
	 ...
	 */
	public static TipiEntry findByUuid_First(
	 ...
	 */
	public static TipiEntry fetchByUuid_First(
		String uuid, OrderByComparator<TipiEntry> orderByComparator) {
	 ...
	 * @throws NoSuchTipiEntryException if a matching tipi entry could not be found
	 */
	public static TipiEntry findByUuid_Last(
			String uuid, OrderByComparator<TipiEntry> orderByComparator)
		throws eu.strasbourg.service.tipi.exception.NoSuchTipiEntryException {
	 ...
	 */
	public static TipiEntry fetchByUuid_Last(
		String uuid, OrderByComparator<TipiEntry> orderByComparator) {
	 ...
	 */
	public static TipiEntry[] findByUuid_PrevAndNext(
			long id, String uuid,
			OrderByComparator<TipiEntry> orderByComparator)
		throws eu.strasbourg.service.tipi.exception.NoSuchTipiEntryException {
	 ...
	 * @return the ordered range of matching tipi entries
	 */
	public static List<TipiEntry> findByDate(
	 ...
	 * @throws NoSuchTipiEntryException if a matching tipi entry could not be found
	 */
	public static TipiEntry findByDate_First(
	 ...
	 * @return the first matching tipi entry, or <code>null</code> if a matching tipi entry could not be found
	 */
	public static TipiEntry fetchByDate_First(
		Date date, OrderByComparator<TipiEntry> orderByComparator) {
	 ...
	 * @throws NoSuchTipiEntryException if a matching tipi entry could not be found
	 */
	public static TipiEntry findByDate_Last(
			Date date, OrderByComparator<TipiEntry> orderByComparator)
		throws eu.strasbourg.service.tipi.exception.NoSuchTipiEntryException {
	 ...
	 * @return the last matching tipi entry, or <code>null</code> if a matching tipi entry could not be found
	 */
	public static TipiEntry fetchByDate_Last(
		Date date, OrderByComparator<TipiEntry> orderByComparator) {
	 ...
	 * @throws NoSuchTipiEntryException if a tipi entry with the primary key could not be found
	 */
	public static TipiEntry[] findByDate_PrevAndNext(
	...
	public static void setPersistence(TipiEntryPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile TipiEntryPersistence _persistence;
