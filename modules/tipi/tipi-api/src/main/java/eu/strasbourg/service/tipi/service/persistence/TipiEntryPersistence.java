...
public interface TipiEntryPersistence extends BasePersistence<TipiEntry> {
	 ...
	 */
	public java.util.List<TipiEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<TipiEntry> findByUuid(
	...
	public java.util.List<TipiEntry> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TipiEntry>
			orderByComparator);
	 ...
	 * @return the ordered range of matching tipi entries
	 */
	public java.util.List<TipiEntry> findByDate(
