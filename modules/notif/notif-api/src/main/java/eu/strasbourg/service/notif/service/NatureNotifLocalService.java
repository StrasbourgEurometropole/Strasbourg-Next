...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.notif.model.NatureNotif"
	}
)
@ProviderType
@Transactional(
...
public interface NatureNotifLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.notif.service.impl.NatureNotifLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the nature notif local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NatureNotifLocalServiceUtil} if injection and service tracking are not available.
	 */
