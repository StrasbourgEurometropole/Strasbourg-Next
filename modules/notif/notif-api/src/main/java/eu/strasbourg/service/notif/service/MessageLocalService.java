 ...
 */
@OSGiBeanProperties(
	property = {"model.class.name=eu.strasbourg.service.notif.model.Message"}
)
@ProviderType
@Transactional(
...
public interface MessageLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.notif.service.impl.MessageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the message local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MessageLocalServiceUtil} if injection and service tracking are not available.
	 */
