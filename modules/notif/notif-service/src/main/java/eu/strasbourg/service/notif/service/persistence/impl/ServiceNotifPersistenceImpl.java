...
public class ServiceNotifPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setServiceNotifUtilPersistence(this);
	}

	public void destroy() {
		_setServiceNotifUtilPersistence(null);

		entityCache.removeCache(ServiceNotifImpl.class.getName());
	}

	private void _setServiceNotifUtilPersistence(
		ServiceNotifPersistence serviceNotifPersistence) {

		try {
			Field field = ServiceNotifUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, serviceNotifPersistence);
		}
