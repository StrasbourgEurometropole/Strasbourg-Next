 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.like.service.impl.LikeServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
...
public abstract class LikeServiceBaseImpl
	 ...
	 */
	public eu.strasbourg.service.like.service.LikeLocalService
		getLikeLocalService() {
	 ...
	 */
	public void setLikeLocalService(
		eu.strasbourg.service.like.service.LikeLocalService likeLocalService) {

		this.likeLocalService = likeLocalService;
	}

	/**
	 * Returns the like remote service.
	 *
	 * @return the like remote service
	 */
	...
	/**
	 * Sets the like remote service.
	 *
	 * @param likeService the like remote service
	 */
	...
	public String getOSGiServiceIdentifier() {
		return LikeService.class.getName();
	}
	...
	@BeanReference(
		type = eu.strasbourg.service.like.service.LikeLocalService.class
	)
	protected eu.strasbourg.service.like.service.LikeLocalService
		likeLocalService;

	@BeanReference(type = LikeService.class)
