 ...
 * @author BMA
 */
public class BudgetPhaseActionDropdownItemsProvider {

    public BudgetPhaseActionDropdownItemsProvider(
    ...
    /**
     * The list of dropdown items to display for all budget phase
     */
    ...
    private UnsafeConsumer<DropdownItem, Exception> _getExportActionUnsafeConsumer() {
        ...
        return dropdownItem -> {
            ...
            resourceURL.setResourceID("exportBudgetPhaseSupportsXlsx");
            resourceURL.setParameter("budgetPhaseId", String.valueOf(_budgetPhase.getBudgetPhaseId()));
