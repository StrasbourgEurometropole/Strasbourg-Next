...
public class ManagementParticipationsToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

    public ManagementParticipationsToolBarDisplayContext(
            HttpServletRequest httpServletRequest,
            LiferayPortletRequest liferayPortletRequest,
            LiferayPortletResponse liferayPortletResponse,
            ViewParticipationsDisplayContext viewParticipationsDisplayContext) throws PortalException {
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                viewParticipationsDisplayContext.getSearchContainer());
        _viewParticipationsDisplayContext = viewParticipationsDisplayContext;
    ...
    public String getSearchContainerId() {
        return "participationsSearchContainer";
    }
    ...
    protected List<DropdownItem> getFilterVocabularyDropdownItems() {
        ...
        for (AssetVocabulary vocabulary : getParticipationVocabularies()) {
            filterVocabularyDropdownItems.add(
                    DropdownItemBuilder
                            .setActive(_viewParticipationsDisplayContext.hasVocabulary(vocabulary.getName()))
    ...
    public List<LabelItem> getFilterLabelItems() {
        Map<String, String> categVocabulariesSelected = _viewParticipationsDisplayContext.getCategVocabularies();
    ...
    public String getSearchActionURL() {
        return PortletURLBuilder.createRenderURL(liferayPortletResponse)
                ...
                .setParameter("tab","participations").buildString();
    }
        ...
        return CreationMenuBuilder.addPrimaryDropdownItem(
                dropdownItem -> {
                    ...
                    dropdownItem.setHref(
                            ...
                            "tab", "participations",
                            "cmd", "editParticipation",
                            "mvcPath", "/project-bo-edit-participation.jsp",
    ...
    public Boolean isShowCreationMenu() {
        ...
        if(_themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.PROJECT_BO, StrasbourgPortletKeys.PROJECT_BO, "ADD_PARTICIPATION") &&
    ...
    private final ViewParticipationsDisplayContext _viewParticipationsDisplayContext;
