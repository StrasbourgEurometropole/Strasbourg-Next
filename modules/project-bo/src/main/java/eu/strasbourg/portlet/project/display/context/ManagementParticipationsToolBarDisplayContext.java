...
public class ManagementParticipationsToolBarDisplayContext extends ManagementBaseToolBarDisplayContext<Participation> {
    ...
    public ManagementParticipationsToolBarDisplayContext(
        ...
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                Participation.class, searchContainer);
