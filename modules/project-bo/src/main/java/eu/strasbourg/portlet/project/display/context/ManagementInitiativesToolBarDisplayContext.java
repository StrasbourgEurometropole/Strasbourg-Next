...
public class ManagementInitiativesToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

    public ManagementInitiativesToolBarDisplayContext(
            HttpServletRequest httpServletRequest,
            LiferayPortletRequest liferayPortletRequest,
            LiferayPortletResponse liferayPortletResponse,
            ViewInitiativesDisplayContext viewInitiativesDisplayContext) throws PortalException {
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                viewInitiativesDisplayContext.getSearchContainer());
        _viewInitiativesDisplayContext = viewInitiativesDisplayContext;
    ...
    public String getSearchContainerId() {
        return "initiativesSearchContainer";
    }
    ...
    protected List<DropdownItem> getFilterVocabularyDropdownItems() {
        ...
        for (AssetVocabulary vocabulary : getInitiativeVocabularies()) {
            filterVocabularyDropdownItems.add(
                    DropdownItemBuilder
                            .setActive(_viewInitiativesDisplayContext.hasVocabulary(vocabulary.getName()))
    ...
    public List<LabelItem> getFilterLabelItems() {
        Map<String, String> categVocabulariesSelected = _viewInitiativesDisplayContext.getCategVocabularies();
        ...
        return CreationMenuBuilder.addPrimaryDropdownItem(
                dropdownItem -> {
                    ...
                    dropdownItem.setHref(
                            ...
                            "tab", "initiatives",
                            "cmd", "editInitiative",
                            "mvcPath", "/project-bo-edit-initiative.jsp",
    ...
    public Boolean isShowCreationMenu() {
        ...
        if(_themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.PROJECT_BO, StrasbourgPortletKeys.PROJECT_BO, "ADD_INITIATIVE") &&
    ...
    private final ViewInitiativesDisplayContext _viewInitiativesDisplayContext;
