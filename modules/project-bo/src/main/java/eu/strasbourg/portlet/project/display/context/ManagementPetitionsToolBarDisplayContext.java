...
public class ManagementPetitionsToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

    public ManagementPetitionsToolBarDisplayContext(
            HttpServletRequest httpServletRequest,
            LiferayPortletRequest liferayPortletRequest,
            LiferayPortletResponse liferayPortletResponse,
            ViewPetitionsDisplayContext viewPetitionsDisplayContext) throws PortalException {
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                viewPetitionsDisplayContext.getSearchContainer());
        _viewPetitionsDisplayContext = viewPetitionsDisplayContext;
    ...
    public String getSearchContainerId() {
        return "petitionsSearchContainer";
    }
    ...
    protected List<DropdownItem> getFilterVocabularyDropdownItems() {
        ...
        for (AssetVocabulary vocabulary : getPetitionVocabularies()) {
            filterVocabularyDropdownItems.add(
                    DropdownItemBuilder
                            .setActive(_viewPetitionsDisplayContext.hasVocabulary(vocabulary.getName()))
    ...
    public List<LabelItem> getFilterLabelItems() {
        Map<String, String> categVocabulariesSelected = _viewPetitionsDisplayContext.getCategVocabularies();
        ...
        return CreationMenuBuilder.addPrimaryDropdownItem(
                dropdownItem -> {
                    ...
                    dropdownItem.setHref(
                            ...
                            "tab", "petitions",
                            "cmd", "editPetition",
                            "mvcPath", "/project-bo-edit-petition.jsp",
    ...
    public Boolean isShowCreationMenu() {
        ...
        if(_themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.PROJECT_BO, StrasbourgPortletKeys.PROJECT_BO, "ADD_PETITION") &&
    ...
    /**
     * Get petition Vocabularies
     */
    protected List<AssetVocabulary> getPetitionVocabularies() {
        if(_vocabularies == null) {
            ThemeDisplay themeDisplay =
                    (ThemeDisplay) httpServletRequest.getAttribute(
                            WebKeys.THEME_DISPLAY);
            long companyGroupId = themeDisplay.getCompanyGroupId();
            long classNameId = ClassNameLocalServiceUtil.getClassNameId(Petition.class);
    ...
    private final ViewPetitionsDisplayContext _viewPetitionsDisplayContext;
