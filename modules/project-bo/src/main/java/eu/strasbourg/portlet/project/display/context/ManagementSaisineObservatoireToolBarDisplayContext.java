...
public class ManagementSaisineObservatoireToolBarDisplayContext extends ManagementBaseToolBarDisplayContext<SaisineObservatoire> {
    ...
    public ManagementSaisineObservatoireToolBarDisplayContext(
        ...
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                SaisineObservatoire.class, searchContainer);
    ...
    protected boolean hasUpdatePermission() {
        return !WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(
                ...
                SaisineObservatoire.class.getName())
