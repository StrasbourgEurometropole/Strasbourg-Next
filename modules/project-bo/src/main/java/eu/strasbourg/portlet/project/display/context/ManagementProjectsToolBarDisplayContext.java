...
public class ManagementProjectsToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

    public ManagementProjectsToolBarDisplayContext(
            HttpServletRequest httpServletRequest,
            LiferayPortletRequest liferayPortletRequest,
            LiferayPortletResponse liferayPortletResponse,
            ViewProjectsDisplayContext viewProjectsDisplayContext) throws PortalException {
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                viewProjectsDisplayContext.getSearchContainer());
        _viewProjectsDisplayContext = viewProjectsDisplayContext;
    ...
    protected List<DropdownItem> getFilterVocabularyDropdownItems() {
        ...
        for (AssetVocabulary vocabulary : getProjectVocabularies()) {
            filterVocabularyDropdownItems.add(
                    DropdownItemBuilder
                            .setActive(_viewProjectsDisplayContext.hasVocabulary(vocabulary.getName()))
    ...
    public List<LabelItem> getFilterLabelItems() {
        Map<String, String> categVocabulariesSelected = _viewProjectsDisplayContext.getCategVocabularies();
    ...
    private final ViewProjectsDisplayContext _viewProjectsDisplayContext;
