    ...
    <div class="row">
        ...
        <div class="col-sm-8 mns-content-agenda-detail" >
            <div class="col-xs-12">
                ...
                <div class="mns-indic">
                    <span class="ico-map-marker">${entry.getPlaceAlias(locale)}</span>
                    <span class="ico-type">${entry.getTypeLabel(locale)}</span>
                </div>
            ...
            <div class="mns-wrapper-info-more">
                ...
                <#if entry.bookingURL?has_content || entry.getBookingDescription(locale)?has_content>
                    <div class="mns-info-more col-xs-12">
                        <h2 class="mns-title-detail-actu col-sm-4"><@liferay_ui.message key="eu.booking" /></h2>
                ...
                <div class="mns-info-more col-xs-12">
                    <#if entry.hasAnyAccessForDisabled() || entry.getAccessForDisabled(locale)?has_content >
                        <h2 class="mns-title-detail-actu col-sm-4" style="padding-bottom: 10px;"><@liferay_ui.message key="eu.services-for-disabled" /></h2>
                ...
                <div class="mns-info-more col-xs-12">
                    <#if entry.getAccess(locale)?has_content>
                        <h2 class="mns-title-detail-actu col-sm-4"><@liferay_ui.message key="access" /></h2>
                                ...
                                <div class="rte">
                                    ...
                                    <form id="contactForm" action="${contactURL}#contactForm" name="contactForm" method="post" class="mns-wi mns-wi-contact-form">
                                        ...
                                        <div class="mns-submit">
                                            <span></span>
                                            <input type="submit" id="submit" value="<@liferay_ui.message key="contact.send" />" aria-label="<@liferay_ui.message key="contact.send" />">
                                        </div>
                                    </form>
