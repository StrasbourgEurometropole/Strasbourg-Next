            ...
            <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                ...
                <a href="#">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top1">
                        <img src="${subtitle.siblings[0].children[4].getData()}" alt="" width="670" height="750" class="fit-cover" />
                    </figure>
                </a>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="${subtitle.siblings[1].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top2">
                        <img src="${subtitle.siblings[1].children[4].getData()}" alt="" width="570" height="570" class="fit-cover" />
                    </figure>
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                <a href="${subtitle.siblings[2].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top1">
                        <img src="${subtitle.siblings[2].children[4].getData()}" alt="" class="fit-cover"/>
                    </figure>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="${subtitle.siblings[3].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top2">
                        <img src="${subtitle.siblings[3].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                <a href="${subtitle.siblings[4].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top1">
                        <img src="${subtitle.siblings[4].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="${subtitle.siblings[5].children[4].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top2">
                        <img src="${subtitle.siblings[5].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                <a href="${subtitle.siblings[6].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top2">
                        <img src="${subtitle.siblings[6].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
        </div>
            ...
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                ...
                <a href="${subtitle.siblings[7].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top8">
                        <img src="${subtitle.siblings[7].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                <a href="${subtitle.siblings[8].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top8">
                        <img src="${subtitle.siblings[8].children[4].getData()}" alt="" class="fit-cover"/>
                    </figure>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                ...
                <a href="${subtitle.siblings[9].children[3].data}">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top8">
                        <img src="${subtitle.siblings[9].children[4].getData()}" alt="" class="fit-cover" />
                    </figure>
                </a>
            </div>
