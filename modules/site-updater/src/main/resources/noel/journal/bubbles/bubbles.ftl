...
<div class="mns-wrapper-home-entry">
    <div class="container mns-home-entry mns-p50">
        <img src="/o/christmas-2018-theme/images/deco-big-elipse.png" width="284" height="284" class="deco-bg" alt="" />
        ...
        <div>
            <div class="mns-bloc-entry">
                <img src="/o/christmas-2018-theme/images/deco-elipse-or.png" width="232" height="232" class="deco" alt=""/>
                <img src="/o/christmas-2018-theme/images/deco-stars-grey.png" width="400" height="400" class="deco-stars" alt=""/>
                <#list bubbleTitle.getSiblings() as cur_bubble>
                    <div class="mns-elipse-${cur_bubble?counter}">
                        <a href="${cur_bubble.children[1].data}">
                            <figure>
                                <img src="/o/christmas-2018-theme/images/home-elipse-${cur_bubble?counter}.jpeg" width="400" height="400" alt="" class="mns-image" />
                            </figure>
                            <div class="caption">
                                <div>
