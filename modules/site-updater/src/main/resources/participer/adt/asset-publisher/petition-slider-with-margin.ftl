    ...
    <section class="pro-bloc-slider pro-slider-event">
        ...
        <div class="container">
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <a href="${themeDisplay.getPortalURL()}${strasbourg.homeURL()}petitions" class="pro-btn" title="Lien vers la page du Listing des pétitions">Tout voir</a>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <#list entries as curEntry>
                        ...
                        <div class="item pro-bloc-card-petition" data-linkall="a">
                            <div class="pro-header-petition">
                                <figure role="group">
                                    <img src="${entry.getAuthorImageURL()}${(entry.getAuthorImageURL()?contains('?'))?then('&','?')}imagePreview=1" loading="lazy" width="40" height="40" alt="Image de profil">
                                </figure>
                                <p>Pétition publiée par :</p>
                                <p><strong>${entry.getAuthorLabel()?html}</strong></p>
                            </div>
                            <div class="pro-content-petition">
                                <a href="${strasbourg.homeURL()}detail-petition/-/entity/id/${entry.petitionId}" title="lien de la page"><h3>${entry.title?html}</h3></a>
