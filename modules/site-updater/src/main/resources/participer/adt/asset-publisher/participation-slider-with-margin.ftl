    ...
    <section id="pro-link-participation" class="pro-bloc-slider pro-slider-participation">
        <div class="container">
            ...
            <div>
                ...
                <a href="${themeDisplay.getPortalURL()}${strasbourg.homeURL()}participations" class="pro-btn" title="Lien vers la page Toutes les participations">Tout voir</a>
            </div>
                        ...
                        <div class="item pro-bloc-card-participation type-color-hexa-${participationColor}" data-linkall="a">
                            <div>
                                <div class="pro-header-participation">
                                    <figure role="group">
                                        <img src="${user.getPortraitURL(themeDisplay)}${(user.getPortraitURL(themeDisplay)?contains('?'))?then('&','?')}imagePreview=1" loading="lazy" width="40" height="40" alt="Image participation"/>
                                    </figure>
                                    <div>
