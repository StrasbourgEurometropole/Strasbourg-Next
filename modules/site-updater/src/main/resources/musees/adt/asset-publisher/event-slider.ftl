                    ...
                    <div class="swiper-wrapper">
                        <#list entries as curEntry>
                            ...
                            <div class="swiper-slide">
                                <a href="${detailURL}" aria-label="${event.getTitle(locale)?html}" title="${event.getTitle(locale)?html}" class="event-thumbnail" style="background-image: url(${event.getImageThumbnailURL()})">
