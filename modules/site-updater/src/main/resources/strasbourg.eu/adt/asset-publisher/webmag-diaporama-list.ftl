...
<div class="st-bloc st-bloc-slider-focus st-js-slider-focus splide st-u-overflow-x-hidden st--type-diaporamas" role="group">
    ...
    <div class="st-wrapper st-wrapper-small st-bloc-slider-focus__bottom">
        ...
        <a href="#" class="st-btn st--btn-secondary st--btn-full-width-mobile st-btn-cta">Tous les diaporamas</a>
    </div>
</div>
