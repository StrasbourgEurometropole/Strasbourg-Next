...
<section id="news-listing" class="pro-search-news">
    <div class="pro-search-listing" id="go-to-top">
        <div class="pro-search-heading">
            <div class="container">
                <div class="pro-search-title">
                    <h1><liferay-ui:message key="eu.project-workshop" /></h1>
                </div>
            </div>
            <!-- File d'ariane -->
        ...
        <div class="container">
            <div class="pro-wrapper-sort">
                ...
                <aui:form action="${searchActionURL}" method="get" name="fm"
                    ...
                    <liferay-util:include page="/forms/placit-project-workshop-form.jsp"
        ...
        <aui:form method="post" name="fm">
            <section class="container pro-listing pro-listing-project-workshop" data-egalize=" > *" data-row="true">
            </section>
        </aui:form>
