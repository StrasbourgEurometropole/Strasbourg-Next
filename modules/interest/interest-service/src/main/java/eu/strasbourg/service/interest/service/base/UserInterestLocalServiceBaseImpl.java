...
public abstract class UserInterestLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, UserInterestLocalService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UserInterest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return userInterestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return userInterestPersistence.countWithDynamicQuery(
	...
	public void afterPropertiesSet() {
		UserInterestLocalServiceUtil.setService(userInterestLocalService);
	}

	public void destroy() {
		UserInterestLocalServiceUtil.setService(null);
	}
