...
/**
 * Provides the base implementation for the interest remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.interest.service.impl.InterestServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
...
public abstract class InterestServiceBaseImpl
	 ...
	 */
	public eu.strasbourg.service.interest.service.InterestLocalService
		getInterestLocalService() {
	...
	public void setInterestLocalService(
		eu.strasbourg.service.interest.service.InterestLocalService
	...
	/**
	 * Returns the interest remote service.
	 *
	 * @return the interest remote service
	 */
	...
	/**
	 * Sets the interest remote service.
	 *
	 * @param interestService the interest remote service
	 */
	...
	public void afterPropertiesSet() {
		InterestServiceUtil.setService(interestService);
	}

	public void destroy() {
		InterestServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InterestService.class.getName();
	}
	...
	@BeanReference(
		type = eu.strasbourg.service.interest.service.InterestLocalService.class
	)
	protected eu.strasbourg.service.interest.service.InterestLocalService
		interestLocalService;

	@BeanReference(type = InterestService.class)
