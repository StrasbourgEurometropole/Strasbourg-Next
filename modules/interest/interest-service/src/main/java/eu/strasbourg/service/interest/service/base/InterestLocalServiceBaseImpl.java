...
/**
 * Provides the base implementation for the interest local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.interest.service.impl.InterestLocalServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 ...
 * @generated
 */
public abstract class InterestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, InterestLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InterestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InterestLocalServiceUtil</code>.
	 */
	...
	public Interest addInterest(Interest interest) {
		...
		return interestPersistence.update(interest);
	}
	...
	public Interest createInterest(long interestId) {
		return interestPersistence.create(interestId);
	}
	...
	public Interest deleteInterest(long interestId) throws PortalException {
		return interestPersistence.remove(interestId);
	}
	...
	public Interest deleteInterest(Interest interest) {
		return interestPersistence.remove(interest);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return interestPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Interest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return interestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return interestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return interestPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Interest fetchInterest(long interestId) {
		return interestPersistence.fetchByPrimaryKey(interestId);
	}
	...
	public Interest fetchInterestByUuidAndGroupId(String uuid, long groupId) {
		return interestPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Interest getInterest(long interestId) throws PortalException {
		return interestPersistence.findByPrimaryKey(interestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(interestLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Interest.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("interestId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			interestLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Interest.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("interestId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Interest>() {
				...
				@Override
				public void performAction(Interest interest)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, interest);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return interestPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement InterestLocalServiceImpl#deleteInterest(Interest) to avoid orphaned data");
		}

		return interestLocalService.deleteInterest((Interest)persistedModel);
	}

	@Override
	public BasePersistence<Interest> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return interestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Interest> getInterestsByUuidAndCompanyId(
		...
		return interestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Interest> getInterestsByUuidAndCompanyId(
		...
		return interestPersistence.findByUuid_C(
	...
	public Interest getInterestByUuidAndGroupId(String uuid, long groupId)
		...
		return interestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Interest> getInterests(int start, int end) {
		return interestPersistence.findAll(start, end);
	}
	...
	public int getInterestsCount() {
		return interestPersistence.countAll();
	}
	 ...
	 */
	public InterestLocalService getInterestLocalService() {
	 ...
	 */
	public void setInterestPersistence(
	 ...
	 */
	public eu.strasbourg.service.interest.service.UserInterestLocalService
		getUserInterestLocalService() {
	...
	public void setUserInterestLocalService(
		eu.strasbourg.service.interest.service.UserInterestLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(interestLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InterestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = interestPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = InterestLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, interestLocalService);
		}
	...
	@BeanReference(type = InterestLocalService.class)
	protected InterestLocalService interestLocalService;

	@BeanReference(type = InterestPersistence.class)
	protected InterestPersistence interestPersistence;

	@BeanReference(
		type = eu.strasbourg.service.interest.service.UserInterestLocalService.class
	)
	protected eu.strasbourg.service.interest.service.UserInterestLocalService
		userInterestLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		InterestLocalServiceBaseImpl.class);
