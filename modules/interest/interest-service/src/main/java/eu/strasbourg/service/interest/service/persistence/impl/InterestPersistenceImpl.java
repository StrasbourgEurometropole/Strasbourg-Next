...
public class InterestPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setInterestUtilPersistence(this);
	}

	public void destroy() {
		_setInterestUtilPersistence(null);

		entityCache.removeCache(InterestImpl.class.getName());
	}

	private void _setInterestUtilPersistence(
		InterestPersistence interestPersistence) {

		try {
			Field field = InterestUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, interestPersistence);
		}
