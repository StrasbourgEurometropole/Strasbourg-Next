...
/**
 * The base model interface for the Interest service. Represents a row in the &quot;interest_Interest&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>eu.strasbourg.service.interest.model.impl.InterestModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>eu.strasbourg.service.interest.model.impl.InterestImpl</code>.
 * </p>
 *
 * @author BenjaminBini
 * @see Interest
...
public interface InterestModel
	extends BaseModel<Interest>, LocalizedModel, ShardedModel,
			StagedGroupedModel, WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a interest model instance should use the {@link Interest} interface instead.
	 */
