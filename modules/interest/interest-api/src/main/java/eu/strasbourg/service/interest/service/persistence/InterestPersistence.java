...
public interface InterestPersistence extends BasePersistence<Interest> {
	 ...
	 */
	public java.util.List<Interest> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Interest> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Interest> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Interest>
			orderByComparator);
	 ...
	 * @return the matching interests
	 */
	public java.util.List<Interest> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching interests
	 */
	public java.util.List<Interest> findByUuid_C(
	 ...
	 * @return the range of matching interests
	 */
	public java.util.List<Interest> findByGroupId(
