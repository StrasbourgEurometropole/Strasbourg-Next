...
/**
 * Provides the local service interface for UserInterest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BenjaminBini
 * @see UserInterestLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.interest.model.UserInterest"
	}
)
@ProviderType
@Transactional(
...
public interface UserInterestLocalService
