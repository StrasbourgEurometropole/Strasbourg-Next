...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		<liferay-ui:search-container-row
			className="eu.strasbourg.service.project.model.Project"
			modelVar="project" cssClass="project-row" keyProperty="projectId" rowIdProperty="projectId"
		>
			...
			<liferay-ui:search-container-column-text name="">
				<div class="data" data-id="${project.projectId}" data-title="${project.title}"></div>
...
<aui:script>
	$('.project-row input[type=checkbox]').on('change', function() {
		...
		if (!multiple) {
			...
			Liferay.Util.getOpener().Liferay.fire('${itemSelectedProjectName}', {
				data: {
					entityId: id,
					title: title
				}
