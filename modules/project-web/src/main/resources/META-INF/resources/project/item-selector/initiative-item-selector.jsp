...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		<liferay-ui:search-container-row
			...
			modelVar="initiative" cssClass="initiative-row" keyProperty="initiativeId" rowIdProperty="initiativeId"
		>
			...
			<liferay-ui:search-container-column-text name="">
				<div class="data" data-id="${initiative.initiativeId}" data-title="${initiative.title}"></div>
...
<aui:script>
	$('.initiative-row input[type=checkbox]').on('change', function() {
