...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		<liferay-ui:search-container-row
			className="eu.strasbourg.service.project.model.Participation"
			modelVar="participation" cssClass="participation-row" keyProperty="participationId" rowIdProperty="participationId"
		>
...
<aui:script>
	$('.participation-row input[type=checkbox]').on('change', function() {
		...
		if (!multiple) {
			...
			Liferay.Util.getOpener().Liferay.fire('${itemSelectedParticipationName}', {
				data: {
					entityId: id,
					title: title
				}
