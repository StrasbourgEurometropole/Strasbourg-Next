...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		<liferay-ui:search-container-results
			results="${saisineObservatoires}"
		/>

		<liferay-ui:search-container-row
			className="eu.strasbourg.service.project.model.SaisineObservatoire"
			modelVar="saisineObservatoire" cssClass="saisine-observatoire-row" keyProperty="saisineObservatoireId" rowIdProperty="saisineObservatoireId"
		>
			...
			<liferay-ui:search-container-column-text name="">
				<div class="data" data-id="${saisineObservatoire.saisineObservatoireId}" data-title="${saisineObservatoire.title}"></div>
...
<aui:script>
	$('.saisine-observatoire-row input[type=checkbox]').on('change', function() {
		...
		if (!multiple) {
			...
			Liferay.Util.getOpener().Liferay.fire('${itemSelectedSaisineObservatoireName}', {
				data: {
					entityId: id,
					title: title
				}
