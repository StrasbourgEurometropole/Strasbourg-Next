	...
	>
		...
		>
			...
			<liferay-ui:search-container-column-text name="">
				<div class="data" data-id="${budgetPhase.budgetPhaseId}" data-title="${budgetPhase.title}"></div>
...
<aui:script>
	$(".budget-phase-row input[type=checkbox]").on('change', function() {
		...
		if (!multiple) {
			...
			Liferay.Util.getOpener().Liferay.fire('${itemSelectedBudgetPhaseName}', {
				data: {
					entityId: id,
					title: title
				}
