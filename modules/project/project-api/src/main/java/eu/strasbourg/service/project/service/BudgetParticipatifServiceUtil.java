...
public class BudgetParticipatifServiceUtil {
	...
	public static BudgetParticipatifService getService() {
		return _service;
	}

	public static void setService(BudgetParticipatifService service) {
		_service = service;
	}

	private static volatile BudgetParticipatifService _service;
