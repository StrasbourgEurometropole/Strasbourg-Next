...
@ImplementationClassName(
	"eu.strasbourg.service.project.model.impl.InitiativeImpl"
)
@ProviderType
public interface Initiative extends InitiativeModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>eu.strasbourg.service.project.model.impl.InitiativeImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Initiative, Long> INITIATIVE_ID_ACCESSOR =
		new Accessor<Initiative, Long>() {
