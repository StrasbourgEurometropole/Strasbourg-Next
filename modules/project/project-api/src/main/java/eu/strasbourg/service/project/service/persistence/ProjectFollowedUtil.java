...
/**
 * The persistence utility for the project followed service. This utility wraps <code>eu.strasbourg.service.project.service.persistence.impl.ProjectFollowedPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProjectFollowedUtil {
	 ...
	 */
	public static Map<Serializable, ProjectFollowed> fetchByPrimaryKeys(
	 ...
	 */
	public static ProjectFollowed update(
		ProjectFollowed projectFollowed, ServiceContext serviceContext) {
	...
	public static ProjectFollowed findByPublikUserId_First(
		...
		throws eu.strasbourg.service.project.exception.
			NoSuchProjectFollowedException {
	...
	public static ProjectFollowed[] findByPublikUserId_PrevAndNext(
		...
		return getPersistence().findByPublikUserId_PrevAndNext(
			projectFollowedId, publikUserId, orderByComparator);
	}
	 ...
	 * @return the range of matching project followeds
	 */
	public static List<ProjectFollowed> findByProjectId(
	 ...
	 * @throws NoSuchProjectFollowedException if a matching project followed could not be found
	 */
	public static ProjectFollowed findByProjectId_First(
			long projectId,
			OrderByComparator<ProjectFollowed> orderByComparator)
		throws eu.strasbourg.service.project.exception.
			NoSuchProjectFollowedException {
	 ...
	 * @return the first matching project followed, or <code>null</code> if a matching project followed could not be found
	 */
	public static ProjectFollowed fetchByProjectId_First(
	 ...
	 * @throws NoSuchProjectFollowedException if a matching project followed could not be found
	 */
	public static ProjectFollowed findByProjectId_Last(
			long projectId,
			OrderByComparator<ProjectFollowed> orderByComparator)
		throws eu.strasbourg.service.project.exception.
			NoSuchProjectFollowedException {
	 ...
	 * @return the last matching project followed, or <code>null</code> if a matching project followed could not be found
	 */
	public static ProjectFollowed fetchByProjectId_Last(
		long projectId, OrderByComparator<ProjectFollowed> orderByComparator) {
	...
	public static ProjectFollowed[] findByProjectId_PrevAndNext(
		...
		return getPersistence().findByProjectId_PrevAndNext(
			projectFollowedId, projectId, orderByComparator);
	}
	...
	public static ProjectFollowed findByPublikUserIdAndProjectId(
		...
		return getPersistence().findByPublikUserIdAndProjectId(
	...
	public static ProjectFollowed fetchByPublikUserIdAndProjectId(
		...
		return getPersistence().fetchByPublikUserIdAndProjectId(
			publikUserId, projectId);
	}
	...
	public static ProjectFollowed fetchByPublikUserIdAndProjectId(
		...
		return getPersistence().fetchByPublikUserIdAndProjectId(
			publikUserId, projectId, useFinderCache);
	}
	...
	public static ProjectFollowed removeByPublikUserIdAndProjectId(
		...
		return getPersistence().removeByPublikUserIdAndProjectId(
			publikUserId, projectId);
	}
	...
	public static int countByPublikUserIdAndProjectId(
		...
		return getPersistence().countByPublikUserIdAndProjectId(
			publikUserId, projectId);
	}
	...
	public static void setPersistence(ProjectFollowedPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile ProjectFollowedPersistence _persistence;
