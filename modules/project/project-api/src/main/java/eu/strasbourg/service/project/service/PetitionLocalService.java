 ...
 */
@OSGiBeanProperties(
	property = {"model.class.name=eu.strasbourg.service.project.model.Petition"}
)
@ProviderType
@Transactional(
...
public interface PetitionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.project.service.impl.PetitionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the petition local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PetitionLocalServiceUtil} if injection and service tracking are not available.
	 */
