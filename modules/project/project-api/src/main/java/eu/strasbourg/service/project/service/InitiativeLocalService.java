...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.project.model.Initiative"
	}
)
@ProviderType
@Transactional(
...
public interface InitiativeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.project.service.impl.InitiativeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the initiative local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InitiativeLocalServiceUtil} if injection and service tracking are not available.
	 */
