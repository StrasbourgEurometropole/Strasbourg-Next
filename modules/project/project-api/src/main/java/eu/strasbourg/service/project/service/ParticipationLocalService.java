...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.project.model.Participation"
	}
)
@ProviderType
@Transactional(
...
public interface ParticipationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.project.service.impl.ParticipationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the participation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ParticipationLocalServiceUtil} if injection and service tracking are not available.
	 */
