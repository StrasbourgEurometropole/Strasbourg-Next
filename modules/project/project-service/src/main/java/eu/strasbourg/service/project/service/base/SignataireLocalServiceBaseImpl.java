...
/**
 * Provides the base implementation for the signataire local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.SignataireLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class SignataireLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SignataireLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SignataireLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SignataireLocalServiceUtil</code>.
	 */
	...
	public Signataire addSignataire(Signataire signataire) {
		...
		return signatairePersistence.update(signataire);
	}
	...
	public Signataire createSignataire(long signataireId) {
		return signatairePersistence.create(signataireId);
	}
	...
	public Signataire deleteSignataire(long signataireId)
		...
		return signatairePersistence.remove(signataireId);
	}
	...
	public Signataire deleteSignataire(Signataire signataire) {
		return signatairePersistence.remove(signataire);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return signatairePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Signataire.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return signatairePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return signatairePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return signatairePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return signatairePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Signataire fetchSignataire(long signataireId) {
		return signatairePersistence.fetchByPrimaryKey(signataireId);
	}
	...
	public Signataire fetchSignataireByUuidAndGroupId(
		...
		return signatairePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Signataire getSignataire(long signataireId) throws PortalException {
		return signatairePersistence.findByPrimaryKey(signataireId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(signataireLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Signataire.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("signataireId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Signataire.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Signataire>() {

				@Override
				public void performAction(Signataire signataire)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, signataire);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return signatairePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SignataireLocalServiceImpl#deleteSignataire(Signataire) to avoid orphaned data");
		}

		return signataireLocalService.deleteSignataire(
			(Signataire)persistedModel);
	}

	@Override
	public BasePersistence<Signataire> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return signatairePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Signataire> getSignatairesByUuidAndCompanyId(
		...
		return signatairePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Signataire> getSignatairesByUuidAndCompanyId(
		...
		return signatairePersistence.findByUuid_C(
	...
	public Signataire getSignataireByUuidAndGroupId(String uuid, long groupId)
		...
		return signatairePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Signataire> getSignataires(int start, int end) {
		return signatairePersistence.findAll(start, end);
	}
	...
	public int getSignatairesCount() {
		return signatairePersistence.countAll();
	}
	 ...
	 */
	public SignataireLocalService getSignataireLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(signataireLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SignataireLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = signatairePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SignataireLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, signataireLocalService);
		}
	...
	@BeanReference(type = SignataireLocalService.class)
	protected SignataireLocalService signataireLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SignataireLocalServiceBaseImpl.class);
