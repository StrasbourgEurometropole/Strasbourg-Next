...
import eu.strasbourg.service.project.service.BudgetSupportLocalService;
...
/**
 * Provides the base implementation for the budget support local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.BudgetSupportLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class BudgetSupportLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements BudgetSupportLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetSupportLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetSupportLocalServiceUtil</code>.
	 */
	...
	public BudgetSupport addBudgetSupport(BudgetSupport budgetSupport) {
		...
		return budgetSupportPersistence.update(budgetSupport);
	}
	...
	public BudgetSupport createBudgetSupport(long budgetSupportId) {
		return budgetSupportPersistence.create(budgetSupportId);
	}
	...
	public BudgetSupport deleteBudgetSupport(long budgetSupportId)
		...
		return budgetSupportPersistence.remove(budgetSupportId);
	}
	...
	public BudgetSupport deleteBudgetSupport(BudgetSupport budgetSupport) {
		return budgetSupportPersistence.remove(budgetSupport);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return budgetSupportPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BudgetSupport.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return budgetSupportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return budgetSupportPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return budgetSupportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return budgetSupportPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BudgetSupport fetchBudgetSupport(long budgetSupportId) {
		return budgetSupportPersistence.fetchByPrimaryKey(budgetSupportId);
	}
	...
	public BudgetSupport fetchBudgetSupportByUuidAndGroupId(
		...
		return budgetSupportPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public BudgetSupport getBudgetSupport(long budgetSupportId)
		...
		return budgetSupportPersistence.findByPrimaryKey(budgetSupportId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(budgetSupportLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BudgetSupport.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("budgetSupportId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(BudgetSupport.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<BudgetSupport>() {

				@Override
				public void performAction(BudgetSupport budgetSupport)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, budgetSupport);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return budgetSupportPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BudgetSupportLocalServiceImpl#deleteBudgetSupport(BudgetSupport) to avoid orphaned data");
		}

		return budgetSupportLocalService.deleteBudgetSupport(
			(BudgetSupport)persistedModel);
	}

	@Override
	public BasePersistence<BudgetSupport> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return budgetSupportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BudgetSupport> getBudgetSupportsByUuidAndCompanyId(
		...
		return budgetSupportPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<BudgetSupport> getBudgetSupportsByUuidAndCompanyId(
		...
		return budgetSupportPersistence.findByUuid_C(
	...
	public BudgetSupport getBudgetSupportByUuidAndGroupId(
		...
		return budgetSupportPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<BudgetSupport> getBudgetSupports(int start, int end) {
		return budgetSupportPersistence.findAll(start, end);
	}
	...
	public int getBudgetSupportsCount() {
		return budgetSupportPersistence.countAll();
	}
	 ...
	 */
	public BudgetSupportLocalService getBudgetSupportLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(budgetSupportLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BudgetSupportLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = budgetSupportPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BudgetSupportLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, budgetSupportLocalService);
		}
	...
	@BeanReference(type = BudgetSupportLocalService.class)
	protected BudgetSupportLocalService budgetSupportLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BudgetSupportLocalServiceBaseImpl.class);
