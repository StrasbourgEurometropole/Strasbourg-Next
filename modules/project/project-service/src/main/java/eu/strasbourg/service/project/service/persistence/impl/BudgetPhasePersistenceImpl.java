...
public class BudgetPhasePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setBudgetPhaseUtilPersistence(this);
	}

	public void destroy() {
		_setBudgetPhaseUtilPersistence(null);

		entityCache.removeCache(BudgetPhaseImpl.class.getName());
	}

	private void _setBudgetPhaseUtilPersistence(
		BudgetPhasePersistence budgetPhasePersistence) {

		try {
			Field field = BudgetPhaseUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, budgetPhasePersistence);
		}
