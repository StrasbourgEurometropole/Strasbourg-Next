...
import eu.strasbourg.service.project.service.SignataireServiceUtil;
...
/**
 * Provides the base implementation for the signataire remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.SignataireServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 * @see eu.strasbourg.service.project.service.impl.SignataireServiceImpl
 * @generated
 */
public abstract class SignataireServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SignataireService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SignataireServiceUtil</code>.
	 */
	 ...
	 */
	public SignataireService getSignataireService() {
	 ...
	 */
	public void setSignataireService(SignataireService signataireService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(signataireService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SignataireService.class.getName();
	}
	...
	private void _setServiceUtilService(SignataireService signataireService) {
		try {
			Field field = SignataireServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, signataireService);
		}
	...
	@BeanReference(type = SignataireService.class)
	protected SignataireService signataireService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SignataireServiceBaseImpl.class);
