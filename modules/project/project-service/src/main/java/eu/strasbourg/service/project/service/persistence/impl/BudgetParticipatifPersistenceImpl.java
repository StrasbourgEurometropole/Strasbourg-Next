...
public class BudgetParticipatifPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setBudgetParticipatifUtilPersistence(this);
	}

	public void destroy() {
		_setBudgetParticipatifUtilPersistence(null);

		entityCache.removeCache(BudgetParticipatifImpl.class.getName());
	}

	private void _setBudgetParticipatifUtilPersistence(
		BudgetParticipatifPersistence budgetParticipatifPersistence) {

		try {
			Field field = BudgetParticipatifUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, budgetParticipatifPersistence);
		}
