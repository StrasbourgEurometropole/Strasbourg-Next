...
import eu.strasbourg.service.project.service.InitiativeService;
import eu.strasbourg.service.project.service.InitiativeServiceUtil;
...
/**
 * Provides the base implementation for the initiative remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.InitiativeServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
...
public abstract class InitiativeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InitiativeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InitiativeServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(initiativeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InitiativeService.class.getName();
	}
	...
	private void _setServiceUtilService(InitiativeService initiativeService) {
		try {
			Field field = InitiativeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, initiativeService);
		}
	...
	@BeanReference(type = InitiativeService.class)
	...
	private static final Log _log = LogFactoryUtil.getLog(
		InitiativeServiceBaseImpl.class);
