package eu.strasbourg.service.project.upgrade;
...
public class UpgradeRegistrator implements UpgradeStepRegistrator {
    ...
    public void register(Registry registry) {
        ...
        registry.register( "1.0.0", "1.1.0",
                new eu.strasbourg.service.project.upgrade.v1_1_0.UpgradeSchema());
        ...
        registry.register( "1.3.0", "1.4.0",
                new eu.strasbourg.service.project.upgrade.v1_4_0.UpgradeSchema());
        registry.register( "1.4.0", "1.5.0",
                new eu.strasbourg.service.project.upgrade.v1_5_0.UpgradeSchema());
    }
}