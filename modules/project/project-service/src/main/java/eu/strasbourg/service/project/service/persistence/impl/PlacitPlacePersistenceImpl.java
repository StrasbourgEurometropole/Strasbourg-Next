...
public class PlacitPlacePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setPlacitPlaceUtilPersistence(this);
	}

	public void destroy() {
		_setPlacitPlaceUtilPersistence(null);

		entityCache.removeCache(PlacitPlaceImpl.class.getName());
	}

	private void _setPlacitPlaceUtilPersistence(
		PlacitPlacePersistence placitPlacePersistence) {

		try {
			Field field = PlacitPlaceUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, placitPlacePersistence);
		}
