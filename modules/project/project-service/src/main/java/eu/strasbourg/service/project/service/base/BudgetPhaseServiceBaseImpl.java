...
import eu.strasbourg.service.project.service.BudgetPhaseServiceUtil;
 ...
 * @generated
 */
public abstract class BudgetPhaseServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetPhaseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetPhaseServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(budgetPhaseService);
	}
	...
	private void _setServiceUtilService(BudgetPhaseService budgetPhaseService) {
		try {
			Field field = BudgetPhaseServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, budgetPhaseService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BudgetPhaseServiceBaseImpl.class);
