...
import eu.strasbourg.service.project.service.SaisineObservatoireService;
import eu.strasbourg.service.project.service.SaisineObservatoireServiceUtil;
...
/**
 * Provides the base implementation for the saisine observatoire remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.SaisineObservatoireServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 * @see eu.strasbourg.service.project.service.impl.SaisineObservatoireServiceImpl
 * @generated
 */
public abstract class SaisineObservatoireServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, SaisineObservatoireService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SaisineObservatoireService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SaisineObservatoireServiceUtil</code>.
	 */
	 ...
	 */
	public SaisineObservatoireService getSaisineObservatoireService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(saisineObservatoireService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SaisineObservatoireService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = SaisineObservatoireServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, saisineObservatoireService);
		}
	...
	@BeanReference(type = SaisineObservatoireService.class)
	protected SaisineObservatoireService saisineObservatoireService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SaisineObservatoireServiceBaseImpl.class);
