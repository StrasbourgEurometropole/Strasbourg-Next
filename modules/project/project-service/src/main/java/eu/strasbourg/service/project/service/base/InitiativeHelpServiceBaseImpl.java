...
import eu.strasbourg.service.project.service.InitiativeHelpServiceUtil;
...
/**
 * Provides the base implementation for the initiative help remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.InitiativeHelpServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 * @see eu.strasbourg.service.project.service.impl.InitiativeHelpServiceImpl
 * @generated
 */
public abstract class InitiativeHelpServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, InitiativeHelpService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InitiativeHelpService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InitiativeHelpServiceUtil</code>.
	 */
	 ...
	 */
	public InitiativeHelpService getInitiativeHelpService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(initiativeHelpService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InitiativeHelpService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = InitiativeHelpServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, initiativeHelpService);
		}
	...
	@BeanReference(type = InitiativeHelpService.class)
	protected InitiativeHelpService initiativeHelpService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		InitiativeHelpServiceBaseImpl.class);
