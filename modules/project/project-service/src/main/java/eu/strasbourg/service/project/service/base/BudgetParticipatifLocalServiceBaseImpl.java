...
/**
 * Provides the base implementation for the budget participatif local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.BudgetParticipatifLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
...
public abstract class BudgetParticipatifLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetParticipatifLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetParticipatifLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return budgetParticipatifPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return budgetParticipatifPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BudgetParticipatifLocalServiceImpl#deleteBudgetParticipatif(BudgetParticipatif) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<BudgetParticipatif> getBasePersistence() {
	...
	public List<BudgetParticipatif> getBudgetParticipatifs(int start, int end) {
		return budgetParticipatifPersistence.findAll(start, end);
	}
	...
	public int getBudgetParticipatifsCount() {
		return budgetParticipatifPersistence.countAll();
	}
	 ...
	 */
	public BudgetParticipatifLocalService getBudgetParticipatifLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(budgetParticipatifLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BudgetParticipatifLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				BudgetParticipatifLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, budgetParticipatifLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BudgetParticipatifLocalServiceBaseImpl.class);
