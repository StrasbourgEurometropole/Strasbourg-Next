...
public class InitiativePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setInitiativeUtilPersistence(this);
	}

	public void destroy() {
		_setInitiativeUtilPersistence(null);

		entityCache.removeCache(InitiativeImpl.class.getName());
	}

	private void _setInitiativeUtilPersistence(
		InitiativePersistence initiativePersistence) {

		try {
			Field field = InitiativeUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, initiativePersistence);
		}
