...
/**
 * Provides the base implementation for the initiative local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.InitiativeLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class InitiativeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, InitiativeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InitiativeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InitiativeLocalServiceUtil</code>.
	 */
	...
	public Initiative addInitiative(Initiative initiative) {
		...
		return initiativePersistence.update(initiative);
	}
	...
	public Initiative createInitiative(long initiativeId) {
		return initiativePersistence.create(initiativeId);
	}
	...
	public Initiative deleteInitiative(long initiativeId)
		...
		return initiativePersistence.remove(initiativeId);
	}
	...
	public Initiative deleteInitiative(Initiative initiative) {
		return initiativePersistence.remove(initiative);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return initiativePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Initiative.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return initiativePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return initiativePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return initiativePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Initiative fetchInitiative(long initiativeId) {
		return initiativePersistence.fetchByPrimaryKey(initiativeId);
	}
	...
	public Initiative fetchInitiativeByUuidAndGroupId(
		...
		return initiativePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Initiative getInitiative(long initiativeId) throws PortalException {
		return initiativePersistence.findByPrimaryKey(initiativeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(initiativeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Initiative.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("initiativeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Initiative.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Initiative>() {
				...
				@Override
				public void performAction(Initiative initiative)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, initiative);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return initiativePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement InitiativeLocalServiceImpl#deleteInitiative(Initiative) to avoid orphaned data");
		}

		return initiativeLocalService.deleteInitiative(
			(Initiative)persistedModel);
	}

	@Override
	public BasePersistence<Initiative> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return initiativePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Initiative> getInitiativesByUuidAndCompanyId(
		...
		return initiativePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Initiative> getInitiativesByUuidAndCompanyId(
		...
		return initiativePersistence.findByUuid_C(
	...
	public Initiative getInitiativeByUuidAndGroupId(String uuid, long groupId)
		...
		return initiativePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Initiative> getInitiatives(int start, int end) {
		return initiativePersistence.findAll(start, end);
	}
	...
	public int getInitiativesCount() {
		return initiativePersistence.countAll();
	}
	 ...
	 */
	public InitiativeLocalService getInitiativeLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(initiativeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InitiativeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = initiativePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = InitiativeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, initiativeLocalService);
		}
	...
	@BeanReference(type = InitiativeLocalService.class)
	protected InitiativeLocalService initiativeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		InitiativeLocalServiceBaseImpl.class);
