...
public class ProjectTimelinePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setProjectTimelineUtilPersistence(this);
	}

	public void destroy() {
		_setProjectTimelineUtilPersistence(null);

		entityCache.removeCache(ProjectTimelineImpl.class.getName());
	}

	private void _setProjectTimelineUtilPersistence(
		ProjectTimelinePersistence projectTimelinePersistence) {

		try {
			Field field = ProjectTimelineUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, projectTimelinePersistence);
		}
