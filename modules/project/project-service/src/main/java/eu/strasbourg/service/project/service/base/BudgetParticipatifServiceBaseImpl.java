...
import eu.strasbourg.service.project.service.BudgetParticipatifService;
import eu.strasbourg.service.project.service.BudgetParticipatifServiceUtil;
...
/**
 * Provides the base implementation for the budget participatif remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.BudgetParticipatifServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class BudgetParticipatifServiceBaseImpl
	extends BaseServiceImpl
	implements BudgetParticipatifService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetParticipatifService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetParticipatifServiceUtil</code>.
	 */
	 ...
	 */
	public BudgetParticipatifService getBudgetParticipatifService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(budgetParticipatifService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BudgetParticipatifService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = BudgetParticipatifServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, budgetParticipatifService);
		}
	...
	@BeanReference(type = BudgetParticipatifService.class)
	protected BudgetParticipatifService budgetParticipatifService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BudgetParticipatifServiceBaseImpl.class);
