...
public class BudgetSupportPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setBudgetSupportUtilPersistence(this);
	}

	public void destroy() {
		_setBudgetSupportUtilPersistence(null);

		entityCache.removeCache(BudgetSupportImpl.class.getName());
	}

	private void _setBudgetSupportUtilPersistence(
		BudgetSupportPersistence budgetSupportPersistence) {

		try {
			Field field = BudgetSupportUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, budgetSupportPersistence);
		}
