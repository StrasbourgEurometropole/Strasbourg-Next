...
public class BudgetSupportPersistenceImpl
	...
	private FinderPath
		_finderPathWithPaginationFindByBudgetParticipatifIdPublikUserId;
	private FinderPath
		_finderPathWithoutPaginationFindByBudgetParticipatifIdPublikUserId;
	private FinderPath _finderPathCountByBudgetParticipatifIdPublikUserId;
	 ...
	 */
	@Override
	public List<BudgetSupport> findByBudgetParticipatifIdPublikUserId(
		long budgetParticipatifId, String publikUserId) {

		return findByBudgetParticipatifIdPublikUserId(
	...
	public List<BudgetSupport> findByBudgetParticipatifIdPublikUserId(
		...
		if (list == null) {
			...
			sb.append(
				_FINDER_COLUMN_BUDGETPARTICIPATIFIDPUBLIKUSERID_BUDGETPARTICIPATIFID_2);

			boolean bindPublikUserId = false;

			if (publikUserId.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_BUDGETPARTICIPATIFIDPUBLIKUSERID_PUBLIKUSERID_3);
			}
			else {
				bindPublikUserId = true;

				sb.append(
					_FINDER_COLUMN_BUDGETPARTICIPATIFIDPUBLIKUSERID_PUBLIKUSERID_2);
			}
	 ...
	 */
	@Override
	public BudgetSupport findByBudgetParticipatifIdPublikUserId_First(
			long budgetParticipatifId, String publikUserId,
			OrderByComparator<BudgetSupport> orderByComparator)
		throws NoSuchBudgetSupportException {

		BudgetSupport budgetSupport =
			fetchByBudgetParticipatifIdPublikUserId_First(
	 ...
	 */
	@Override
	public BudgetSupport fetchByBudgetParticipatifIdPublikUserId_First(
		long budgetParticipatifId, String publikUserId,
		OrderByComparator<BudgetSupport> orderByComparator) {

		List<BudgetSupport> list = findByBudgetParticipatifIdPublikUserId(
	 ...
	 */
	@Override
	public BudgetSupport findByBudgetParticipatifIdPublikUserId_Last(
			long budgetParticipatifId, String publikUserId,
			OrderByComparator<BudgetSupport> orderByComparator)
		throws NoSuchBudgetSupportException {

		BudgetSupport budgetSupport =
			fetchByBudgetParticipatifIdPublikUserId_Last(
				budgetParticipatifId, publikUserId, orderByComparator);
	 ...
	 */
	@Override
	public BudgetSupport fetchByBudgetParticipatifIdPublikUserId_Last(
		long budgetParticipatifId, String publikUserId,
		OrderByComparator<BudgetSupport> orderByComparator) {

		int count = countByBudgetParticipatifIdPublikUserId(
	 ...
	 */
	@Override
	public BudgetSupport[] findByBudgetParticipatifIdPublikUserId_PrevAndNext(
			long budgetSupportId, long budgetParticipatifId,
			String publikUserId,
			OrderByComparator<BudgetSupport> orderByComparator)
		throws NoSuchBudgetSupportException {
		...
		try {
			...
			array[0] = getByBudgetParticipatifIdPublikUserId_PrevAndNext(
				session, budgetSupport, budgetParticipatifId, publikUserId,
				orderByComparator, true);

			array[1] = budgetSupport;

			array[2] = getByBudgetParticipatifIdPublikUserId_PrevAndNext(
				session, budgetSupport, budgetParticipatifId, publikUserId,
				orderByComparator, false);
	...
	protected BudgetSupport getByBudgetParticipatifIdPublikUserId_PrevAndNext(
		Session session, BudgetSupport budgetSupport, long budgetParticipatifId,
		String publikUserId, OrderByComparator<BudgetSupport> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByBudgetParticipatifIdPublikUserId(
		long budgetParticipatifId, String publikUserId) {

		for (BudgetSupport budgetSupport :
				findByBudgetParticipatifIdPublikUserId(
					budgetParticipatifId, publikUserId, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByBudgetParticipatifIdPublikUserId(
		long budgetParticipatifId, String publikUserId) {

		publikUserId = Objects.toString(publikUserId, "");

		FinderPath finderPath =
			_finderPathCountByBudgetParticipatifIdPublikUserId;
	...
	public void afterPropertiesSet() {
		...
		_finderPathCountByBudgetParticipatifIdPublikUserId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByBudgetParticipatifIdPublikUserId",
			new String[] {Long.class.getName(), String.class.getName()},
