...
public abstract class InitiativeHelpLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, InitiativeHelpLocalService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			InitiativeHelp.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return initiativeHelpPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return initiativeHelpPersistence.countWithDynamicQuery(
