...
import eu.strasbourg.service.project.service.BudgetSupportService;
import eu.strasbourg.service.project.service.BudgetSupportServiceUtil;
...
/**
 * Provides the base implementation for the budget support remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.project.service.impl.BudgetSupportServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class BudgetSupportServiceBaseImpl
	extends BaseServiceImpl
	implements BudgetSupportService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BudgetSupportService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BudgetSupportServiceUtil</code>.
	 */
	 ...
	 */
	public BudgetSupportService getBudgetSupportService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(budgetSupportService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BudgetSupportService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = BudgetSupportServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, budgetSupportService);
		}
	...
	@BeanReference(type = BudgetSupportService.class)
	protected BudgetSupportService budgetSupportService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BudgetSupportServiceBaseImpl.class);
