...
public class ProjectFollowedPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setProjectFollowedUtilPersistence(this);
	}

	public void destroy() {
		_setProjectFollowedUtilPersistence(null);

		entityCache.removeCache(ProjectFollowedImpl.class.getName());
	}

	private void _setProjectFollowedUtilPersistence(
		ProjectFollowedPersistence projectFollowedPersistence) {

		try {
			Field field = ProjectFollowedUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, projectFollowedPersistence);
		}
