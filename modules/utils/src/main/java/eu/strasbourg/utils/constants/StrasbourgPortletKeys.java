...
public class StrasbourgPortletKeys {
	...
	public static final String VIDEO_BO = "eu_strasbourg_portlet_video_VideoBOPortlet";
	public static final String VIDEO_WEB = "eu_strasbourg_portlet_video_VideoPortlet";
	...
	public static final String FAMILY_KIOSK_WEB = "eu_strasbourg_portlet_familyKiosk_FamilyKioskWebPortlet";
	...
	public static final String FORM_SEND_BO = "eu_strasbourg_portlet_form_send_FormSendBOPortlet";

	public static final String SLIDER_UNE_WEB = "eu_strasbourg_portlet_slider_une_SliderUnePortlet";
