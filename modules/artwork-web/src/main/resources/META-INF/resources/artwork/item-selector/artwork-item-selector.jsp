...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		<liferay-ui:search-container-row
			...
			modelVar="artwork" cssClass="artwork-row" keyProperty="artworkId" rowIdProperty="artworkId"
		>
			<liferay-ui:search-container-column-text cssClass="content-column"
				name="title" truncate="true"
				value="${artwork.titleCurrentValue}" />
			...
			<liferay-ui:search-container-column-text name="status">
				...
				<div class="data" data-id="${artwork.artworkId}" data-title="${artwork.getTitle(locale)}"></div>
...
<aui:script>
	$('.artwork-row input[type=checkbox]').on('change', function() {
