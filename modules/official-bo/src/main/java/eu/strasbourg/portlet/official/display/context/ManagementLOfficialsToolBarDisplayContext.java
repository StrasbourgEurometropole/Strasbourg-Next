...
public class ManagementLOfficialsToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {
    ...
    public ManagementLOfficialsToolBarDisplayContext(
        ...
        _viewOfficialsDisplayContext=viewOfficialsDisplayContext;
    ...
    protected List<DropdownItem> getFilterVocabularyDropdownItems() {
        ...
        for (AssetVocabulary vocabulary : getOfficialVocabularies()) {
            filterVocabularyDropdownItems.add(
                    DropdownItemBuilder
                            .setActive(_viewOfficialsDisplayContext.hasVocabulary(vocabulary.getName()))
    ...
    public List<LabelItem> getFilterLabelItems() {
        Map<String, String> categVocabulariesSelected = _viewOfficialsDisplayContext.getCategVocabularies();
    ...
    private final ViewOfficialsDisplayContext _viewOfficialsDisplayContext;
