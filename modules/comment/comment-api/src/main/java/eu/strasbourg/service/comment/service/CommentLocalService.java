 ...
 */
@OSGiBeanProperties(
	property = {"model.class.name=eu.strasbourg.service.comment.model.Comment"}
)
@ProviderType
@Transactional(
...
public interface CommentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.comment.service.impl.CommentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the comment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommentLocalServiceUtil} if injection and service tracking are not available.
	 */
