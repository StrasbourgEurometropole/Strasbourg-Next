...
import eu.strasbourg.service.comment.service.CommentServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.comment.service.impl.CommentServiceImpl}.
 * </p>
 *
...
public abstract class CommentServiceBaseImpl
	extends BaseServiceImpl implements CommentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommentServiceUtil</code>.
	 */
	 ...
	 */
	public eu.strasbourg.service.comment.service.CommentLocalService
	...
	public void setCommentLocalService(
		eu.strasbourg.service.comment.service.CommentLocalService
			commentLocalService) {
	 ...
	 */
	public eu.strasbourg.service.comment.service.SignalementLocalService
		getSignalementLocalService() {
	...
	public void setSignalementLocalService(
		eu.strasbourg.service.comment.service.SignalementLocalService
	 ...
	 */
	public eu.strasbourg.service.comment.service.SignalementService
	...
	public void setSignalementService(
		eu.strasbourg.service.comment.service.SignalementService
			signalementService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(commentService);
	}
	...
	private void _setServiceUtilService(CommentService commentService) {
		try {
			Field field = CommentServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, commentService);
		}
	...
	@BeanReference(
		type = eu.strasbourg.service.comment.service.CommentLocalService.class
	)
	protected eu.strasbourg.service.comment.service.CommentLocalService
		commentLocalService;
	...
	@BeanReference(
		type = eu.strasbourg.service.comment.service.SignalementLocalService.class
	)
	protected eu.strasbourg.service.comment.service.SignalementLocalService
		signalementLocalService;

	@BeanReference(
		type = eu.strasbourg.service.comment.service.SignalementService.class
	)
	protected eu.strasbourg.service.comment.service.SignalementService
		signalementService;
