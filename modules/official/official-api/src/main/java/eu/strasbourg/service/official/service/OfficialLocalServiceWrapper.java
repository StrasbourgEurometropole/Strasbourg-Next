...
public class OfficialLocalServiceWrapper
	 ...
	 */
	@Override
	public eu.strasbourg.service.official.model.Official
	 ...
	 */
	@Override
	public java.util.List<eu.strasbourg.service.official.model.Official>
		findByKeyword(String keyword, long groupId, int start, int end) {

		return _officialLocalService.findByKeyword(
	...
	public BasePersistence<?> getBasePersistence() {
		return _officialLocalService.getBasePersistence();
	}
