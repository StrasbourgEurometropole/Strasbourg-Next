...
import eu.strasbourg.service.edition.service.EditionGalleryService;
import eu.strasbourg.service.edition.service.EditionGalleryServiceUtil;
...
/**
 * Provides the base implementation for the edition gallery remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.edition.service.impl.EditionGalleryServiceImpl}.
 * </p>
 *
 * @author BenjaminBini
 * @see eu.strasbourg.service.edition.service.impl.EditionGalleryServiceImpl
 * @generated
 */
public abstract class EditionGalleryServiceBaseImpl
	extends BaseServiceImpl
	implements EditionGalleryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EditionGalleryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EditionGalleryServiceUtil</code>.
	 */
	 ...
	 */
	public eu.strasbourg.service.edition.service.EditionService
		getEditionService() {
	 ...
	 */
	public void setEditionService(
		eu.strasbourg.service.edition.service.EditionService editionService) {
	 ...
	 */
	public EditionGalleryService getEditionGalleryService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(editionGalleryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EditionGalleryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = EditionGalleryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, editionGalleryService);
		}
	...
	@BeanReference(
		type = eu.strasbourg.service.edition.service.EditionService.class
	)
	protected eu.strasbourg.service.edition.service.EditionService
		editionService;
	...
	@BeanReference(type = EditionGalleryService.class)
	protected EditionGalleryService editionGalleryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EditionGalleryServiceBaseImpl.class);
