...
public interface EditionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.edition.service.impl.EditionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the edition local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EditionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public boolean addEditionGalleryEditions(long galleryId, long[] editionIds);
