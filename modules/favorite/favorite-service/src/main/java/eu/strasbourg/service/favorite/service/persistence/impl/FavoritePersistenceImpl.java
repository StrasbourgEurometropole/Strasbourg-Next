...
public class FavoritePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByGroupIdEntityIdAndTypeId;
	private FinderPath
		_finderPathWithoutPaginationFindByGroupIdEntityIdAndTypeId;
	private FinderPath _finderPathCountByGroupIdEntityIdAndTypeId;
	 ...
	 */
	@Override
	public List<Favorite> findByGroupIdEntityIdAndTypeId(
		long entityGroupId, long entityId, long typeId) {

		return findByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId, QueryUtil.ALL_POS,
	...
	public List<Favorite> findByGroupIdEntityIdAndTypeId(
		...
		return findByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId, start, end, null);
	}
	...
	public List<Favorite> findByGroupIdEntityIdAndTypeId(
		...
		return findByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId, start, end, orderByComparator,
			true);
	}
	...
	public List<Favorite> findByGroupIdEntityIdAndTypeId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByGroupIdEntityIdAndTypeId;
				finderArgs = new Object[] {entityGroupId, entityId, typeId};
			}
		}
		else if (useFinderCache) {
			finderPath =
				_finderPathWithPaginationFindByGroupIdEntityIdAndTypeId;
			finderArgs = new Object[] {
				entityGroupId, entityId, typeId, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Favorite favorite : list) {
					if ((entityGroupId != favorite.getEntityGroupId()) ||
						(entityId != favorite.getEntityId()) ||
						(typeId != favorite.getTypeId())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_ENTITYGROUPID_2);

			sb.append(_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_ENTITYID_2);

			sb.append(_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_TYPEID_2);
	...
	public Favorite findByGroupIdEntityIdAndTypeId_First(
		...
		Favorite favorite = fetchByGroupIdEntityIdAndTypeId_First(
			entityGroupId, entityId, typeId, orderByComparator);
	...
	public Favorite fetchByGroupIdEntityIdAndTypeId_First(
		...
		List<Favorite> list = findByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId, 0, 1, orderByComparator);
	...
	public Favorite findByGroupIdEntityIdAndTypeId_Last(
		...
		Favorite favorite = fetchByGroupIdEntityIdAndTypeId_Last(
			entityGroupId, entityId, typeId, orderByComparator);
	...
	public Favorite fetchByGroupIdEntityIdAndTypeId_Last(
		...
		int count = countByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId);
		...
		List<Favorite> list = findByGroupIdEntityIdAndTypeId(
			entityGroupId, entityId, typeId, count - 1, count,
			orderByComparator);
	...
	public Favorite[] findByGroupIdEntityIdAndTypeId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIdEntityIdAndTypeId_PrevAndNext(
				session, favorite, entityGroupId, entityId, typeId,
				orderByComparator, true);

			array[1] = favorite;

			array[2] = getByGroupIdEntityIdAndTypeId_PrevAndNext(
				session, favorite, entityGroupId, entityId, typeId,
	...
	protected Favorite getByGroupIdEntityIdAndTypeId_PrevAndNext(
		Session session, Favorite favorite, long entityGroupId, long entityId,
		long typeId, OrderByComparator<Favorite> orderByComparator,
		boolean previous) {
	...
	public void removeByGroupIdEntityIdAndTypeId(
		...
		for (Favorite favorite :
				findByGroupIdEntityIdAndTypeId(
					entityGroupId, entityId, typeId, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	...
	public int countByGroupIdEntityIdAndTypeId(
		...
		FinderPath finderPath = _finderPathCountByGroupIdEntityIdAndTypeId;

		Object[] finderArgs = new Object[] {entityGroupId, entityId, typeId};
	...
	private static final String
		_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_ENTITYGROUPID_2 =
			"favorite.entityGroupId = ? AND ";

	private static final String
		_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_ENTITYID_2 =
			"favorite.entityId = ? AND ";

	private static final String
		_FINDER_COLUMN_GROUPIDENTITYIDANDTYPEID_TYPEID_2 =
			"favorite.typeId = ?";
	...
	private FinderPath _finderPathWithPaginationFindByTypeIdAndPublikUserId;
	private FinderPath _finderPathWithoutPaginationFindByTypeIdAndPublikUserId;
	private FinderPath _finderPathCountByTypeIdAndPublikUserId;

	/**
	 * Returns all the favorites where typeId = &#63; and publikUserId = &#63;.
	 *
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 * @return the matching favorites
	 */
	@Override
	public List<Favorite> findByTypeIdAndPublikUserId(
		long typeId, String publikUserId) {

		return findByTypeIdAndPublikUserId(
			typeId, publikUserId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the favorites where typeId = &#63; and publikUserId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>FavoriteModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Favorite> findByTypeIdAndPublikUserId(
		long typeId, String publikUserId, int start, int end) {

		return findByTypeIdAndPublikUserId(
			typeId, publikUserId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the favorites where typeId = &#63; and publikUserId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>FavoriteModelImpl</code>.
	 * </p>
	...
	public List<Favorite> findByTypeIdAndPublikUserId(
		...
		return findByTypeIdAndPublikUserId(
			typeId, publikUserId, start, end, orderByComparator, true);
	}
	...
	public List<Favorite> findByTypeIdAndPublikUserId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByTypeIdAndPublikUserId;
				finderArgs = new Object[] {typeId, publikUserId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByTypeIdAndPublikUserId;
			finderArgs = new Object[] {
				typeId, publikUserId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_TYPEID_2);

			boolean bindPublikUserId = false;

			if (publikUserId.isEmpty()) {
				sb.append(_FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_PUBLIKUSERID_3);
			}
			else {
				bindPublikUserId = true;

				sb.append(_FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_PUBLIKUSERID_2);
			}
	...
	/**
	 * Returns the first favorite in the ordered set where typeId = &#63; and publikUserId = &#63;.
	 *
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Favorite findByTypeIdAndPublikUserId_First(
			long typeId, String publikUserId,
			OrderByComparator<Favorite> orderByComparator)
		throws NoSuchFavoriteException {

		Favorite favorite = fetchByTypeIdAndPublikUserId_First(
			typeId, publikUserId, orderByComparator);
	 ...
	 */
	@Override
	public Favorite fetchByTypeIdAndPublikUserId_First(
		long typeId, String publikUserId,
		OrderByComparator<Favorite> orderByComparator) {

		List<Favorite> list = findByTypeIdAndPublikUserId(
			typeId, publikUserId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last favorite in the ordered set where typeId = &#63; and publikUserId = &#63;.
	 *
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Favorite findByTypeIdAndPublikUserId_Last(
			long typeId, String publikUserId,
			OrderByComparator<Favorite> orderByComparator)
		throws NoSuchFavoriteException {

		Favorite favorite = fetchByTypeIdAndPublikUserId_Last(
			typeId, publikUserId, orderByComparator);
	 ...
	 */
	@Override
	public Favorite fetchByTypeIdAndPublikUserId_Last(
		long typeId, String publikUserId,
		OrderByComparator<Favorite> orderByComparator) {

		int count = countByTypeIdAndPublikUserId(typeId, publikUserId);
		...
		List<Favorite> list = findByTypeIdAndPublikUserId(
			typeId, publikUserId, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the favorites before and after the current favorite in the ordered set where typeId = &#63; and publikUserId = &#63;.
	 *
	 * @param favoriteId the primary key of the current favorite
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 ...
	 */
	@Override
	public Favorite[] findByTypeIdAndPublikUserId_PrevAndNext(
			long favoriteId, long typeId, String publikUserId,
			OrderByComparator<Favorite> orderByComparator)
		throws NoSuchFavoriteException {
		...
		try {
			...
			array[0] = getByTypeIdAndPublikUserId_PrevAndNext(
				session, favorite, typeId, publikUserId, orderByComparator,
				true);

			array[1] = favorite;

			array[2] = getByTypeIdAndPublikUserId_PrevAndNext(
				session, favorite, typeId, publikUserId, orderByComparator,
				false);
	...
	protected Favorite getByTypeIdAndPublikUserId_PrevAndNext(
		Session session, Favorite favorite, long typeId, String publikUserId,
		OrderByComparator<Favorite> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the favorites where typeId = &#63; and publikUserId = &#63; from the database.
	 *
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 */
	@Override
	public void removeByTypeIdAndPublikUserId(
		long typeId, String publikUserId) {

		for (Favorite favorite :
				findByTypeIdAndPublikUserId(
					typeId, publikUserId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of favorites where typeId = &#63; and publikUserId = &#63;.
	 *
	 * @param typeId the type ID
	 * @param publikUserId the publik user ID
	 * @return the number of matching favorites
	 */
	@Override
	public int countByTypeIdAndPublikUserId(long typeId, String publikUserId) {
		publikUserId = Objects.toString(publikUserId, "");

		FinderPath finderPath = _finderPathCountByTypeIdAndPublikUserId;

		Object[] finderArgs = new Object[] {typeId, publikUserId};
	...
	private static final String _FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_TYPEID_2 =
		"favorite.typeId = ? AND ";

	private static final String
		_FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_PUBLIKUSERID_2 =
			"favorite.publikUserId = ?";

	private static final String
		_FINDER_COLUMN_TYPEIDANDPUBLIKUSERID_PUBLIKUSERID_3 =
			"(favorite.publikUserId IS NULL OR favorite.publikUserId = '')";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByGroupIdEntityIdAndTypeId =
			new FinderPath(
				...
				new String[] {"entityGroupId", "entityId", "typeId"}, true);
		...
		_finderPathCountByGroupIdEntityIdAndTypeId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGroupIdEntityIdAndTypeId",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"entityGroupId", "entityId", "typeId"}, false);
		...
		_finderPathWithPaginationFindByTypeIdAndPublikUserId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByTypeIdAndPublikUserId",
			new String[] {
			...
			new String[] {"typeId", "publikUserId"}, true);
		...
		_finderPathCountByTypeIdAndPublikUserId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByTypeIdAndPublikUserId",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"typeId", "publikUserId"}, false);

		FavoriteUtil.setPersistence(this);
	}

	public void destroy() {
		FavoriteUtil.setPersistence(null);
