package eu.strasbourg.service.favorite.upgrade;
...
public class UpgradeRegistrator implements UpgradeStepRegistrator {
    ...
    public void register(Registry registry) {
        ...
        registry.register( "1.0.0", "1.1.0",
                new eu.strasbourg.service.favorite.upgrade.v1_1_0.UpgradeSchema());

        registry.register( "1.1.0", "1.2.0",
                new eu.strasbourg.service.favorite.upgrade.v1_2_0.UpgradeSchema());
    }
}