...
public class SearchLogPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setSearchLogUtilPersistence(this);
	}

	public void destroy() {
		_setSearchLogUtilPersistence(null);

		entityCache.removeCache(SearchLogImpl.class.getName());
	}

	private void _setSearchLogUtilPersistence(
		SearchLogPersistence searchLogPersistence) {

		try {
			Field field = SearchLogUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, searchLogPersistence);
		}
