...
public class FormActionDropdownItemsProvider {
    public FormActionDropdownItemsProvider(DDMFormInstance ddmform, RenderRequest request, RenderResponse _response) {
        this._ddmFormInstance = ddmform;
    ...
    private UnsafeConsumer<DropdownItem, Exception> _getEditActionUnsafeConsumer() {
        ...
        return dropdownItem -> {
            dropdownItem.setHref(PortletURLBuilder.createRenderURL(_response).setMVCPath("/form-send-bo-edit-form-send.jsp")
                    ...
                    .setParameter("tab", "forms").setParameter("formInstanceId", _ddmFormInstance.getFormInstanceId()).buildString());
    ...
    private UnsafeConsumer<DropdownItem, Exception> _getDeleteActionUnsafeConsumer() {
        ...
        return dropdownItem -> {
            dropdownItem.setHref(PortletURLBuilder.createActionURL(_response).setActionName("deleteFormSend").setMVCPath("/form-send-bo-view-forms.jsp")
                    .setBackURL(_themeDisplay.getURLCurrent()).setParameter("tab", "forms").setParameter("formInstanceId", _ddmFormInstance.getFormInstanceId()).buildString());
