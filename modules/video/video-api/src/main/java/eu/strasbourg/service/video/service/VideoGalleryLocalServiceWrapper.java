...
public class VideoGalleryLocalServiceWrapper
	...
	public void deleteVideoVideoGalleries(
		...
		_videoGalleryLocalService.deleteVideoVideoGalleries(
			videoId, videoGalleries);
	}
	...
	public long dynamicQueryCount(
		...
		return _videoGalleryLocalService.dynamicQueryCount(
	 ...
	 */
	@Override
	public eu.strasbourg.service.video.model.VideoGallery
		fetchVideoGalleryByUuidAndGroupId(String uuid, long groupId) {

		return _videoGalleryLocalService.fetchVideoGalleryByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List<eu.strasbourg.service.video.model.VideoGallery>
		...
		return _videoGalleryLocalService.findByKeyword(
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _videoGalleryLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	public java.util.List<eu.strasbourg.service.video.model.VideoGallery>
		...
		return _videoGalleryLocalService.getVideoGalleriesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public eu.strasbourg.service.video.model.VideoGallery
		...
		return _videoGalleryLocalService.getVideoGalleryByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List<eu.strasbourg.service.video.model.VideoGallery>
		...
		return _videoGalleryLocalService.getVideoVideoGalleries(
			videoId, start, end);
	}
	...
	public boolean hasVideoVideoGallery(long videoId, long galleryId) {
		return _videoGalleryLocalService.hasVideoVideoGallery(
			videoId, galleryId);
	}
	...
	public eu.strasbourg.service.video.model.VideoGallery updateStatus(
		...
		return _videoGalleryLocalService.updateStatus(
