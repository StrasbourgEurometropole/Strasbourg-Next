...
public interface VideoPersistence extends BasePersistence<Video> {
	 ...
	 */
	public java.util.List<Video> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Video> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Video> findByUuid(
	 ...
	 * @return the matching videos
	 */
	public java.util.List<Video> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching videos
	 */
	public java.util.List<Video> findByUuid_C(
	 ...
	 * @return the range of matching videos
	 */
	public java.util.List<Video> findByGroupId(
	 ...
	 * @return the matching videos
	 */
	public java.util.List<Video> findByPublicationDateAndStatus(
