...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		...
		>
			...
			<fmt:formatDate value="${practice.modifiedDate}"
			...
			<liferay-ui:search-container-column-text name="status">
				<aui:workflow-status markupView="lexicon" showIcon="false"
					showLabel="false" status="${practice.status}" />
				<div class="data" data-id="${practice.practiceId}" data-title="Activité de ${practice.association.nameCurrentValue}"></div>
...
<aui:script>
	$('.practice-row input[type=checkbox]').on('change', function() {
