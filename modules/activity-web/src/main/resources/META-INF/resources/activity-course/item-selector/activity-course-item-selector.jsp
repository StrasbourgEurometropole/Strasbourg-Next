...
<div id="<portlet:namespace />productsImageSelectorWrapper" class="container-fluid-1280 main-content-body">
	...
	>
		<liferay-ui:search-container-results
			results="${activityCourses}"
		/>

		<liferay-ui:search-container-row
			className="eu.strasbourg.service.activity.model.ActivityCourse"
			modelVar="activityCourse" cssClass="activity-course-row" keyProperty="activityCourseId" rowIdProperty="activityCourseId"
		>
			<liferay-ui:search-container-column-text cssClass="content-column"
				name="title" truncate="true"
				value="${activityCourse.nameCurrentValue}" />

			<fmt:formatDate value="${activityCourse.createDate}"
			...
			<liferay-ui:search-container-column-text name="status">
				...
				<div class="data" data-id="${activityCourse.activityCourseId}" data-title="${activityCourse.getName(locale)}"></div>
...
<aui:script>
	$('.activity-course-row input[type=checkbox]').on('change', function() {
