...
public class UserNotificationTypePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setUserNotificationTypeUtilPersistence(this);
	}

	public void destroy() {
		_setUserNotificationTypeUtilPersistence(null);

		entityCache.removeCache(UserNotificationTypeImpl.class.getName());
	}

	private void _setUserNotificationTypeUtilPersistence(
		UserNotificationTypePersistence userNotificationTypePersistence) {

		try {
			Field field = UserNotificationTypeUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, userNotificationTypePersistence);
		}
