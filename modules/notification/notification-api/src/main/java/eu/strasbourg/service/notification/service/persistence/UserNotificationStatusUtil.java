...
public class UserNotificationStatusUtil {
	 ...
	 */
	public static Map<Serializable, UserNotificationStatus> fetchByPrimaryKeys(
	...
	public static List<UserNotificationStatus> findByNotificationId(
		...
		return getPersistence().findByNotificationId(
			notificationId, start, end);
	}
	...
	public static List<UserNotificationStatus> findByNotificationId(
		...
		return getPersistence().findByNotificationId(
			notificationId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static UserNotificationStatus fetchByNotificationId_First(
		...
		return getPersistence().fetchByNotificationId_First(
			notificationId, orderByComparator);
	}
	...
	public static UserNotificationStatus fetchByNotificationId_Last(
		...
		return getPersistence().fetchByNotificationId_Last(
			notificationId, orderByComparator);
	}
	...
	public static void setPersistence(
		UserNotificationStatusPersistence persistence) {
