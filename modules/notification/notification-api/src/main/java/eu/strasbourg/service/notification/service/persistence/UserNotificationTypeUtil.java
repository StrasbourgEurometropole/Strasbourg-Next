...
/**
 * The persistence utility for the user notification type service. This utility wraps <code>eu.strasbourg.service.notification.service.persistence.impl.UserNotificationTypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class UserNotificationTypeUtil {
	 ...
	 */
	public static Map<Serializable, UserNotificationType> fetchByPrimaryKeys(
	...
	public static UserNotificationType[] findByPublikUserId_PrevAndNext(
		...
		return getPersistence().findByPublikUserId_PrevAndNext(
			userNotificationTypePK, publikUserId, orderByComparator);
	}
	 ...
	 * @return the range of matching user notification types
	 */
	public static List<UserNotificationType> findByTypeId(
	 ...
	 * @throws NoSuchUserNotificationTypeException if a matching user notification type could not be found
	 */
	public static UserNotificationType findByTypeId_First(
			long typeId,
			OrderByComparator<UserNotificationType> orderByComparator)
		throws eu.strasbourg.service.notification.exception.
			NoSuchUserNotificationTypeException {
	 ...
	 * @return the first matching user notification type, or <code>null</code> if a matching user notification type could not be found
	 */
	public static UserNotificationType fetchByTypeId_First(
		long typeId,
		OrderByComparator<UserNotificationType> orderByComparator) {
	 ...
	 * @throws NoSuchUserNotificationTypeException if a matching user notification type could not be found
	 */
	public static UserNotificationType findByTypeId_Last(
			long typeId,
			OrderByComparator<UserNotificationType> orderByComparator)
		throws eu.strasbourg.service.notification.exception.
			NoSuchUserNotificationTypeException {
	 ...
	 * @return the last matching user notification type, or <code>null</code> if a matching user notification type could not be found
	 */
	public static UserNotificationType fetchByTypeId_Last(
		long typeId,
		OrderByComparator<UserNotificationType> orderByComparator) {
	...
	public static UserNotificationType[] findByTypeId_PrevAndNext(
		...
		return getPersistence().findByTypeId_PrevAndNext(
			userNotificationTypePK, typeId, orderByComparator);
	}
	...
	public static void setPersistence(
		UserNotificationTypePersistence persistence) {

		_persistence = persistence;
	}

	private static volatile UserNotificationTypePersistence _persistence;
