...
public class EditionItemSelectorView
	implements ItemSelectorView<EditionItemSelectorCriterion> {
	...
	@Override
	public Class<EditionItemSelectorCriterion> getItemSelectorCriterionClass() {
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		EditionItemSelectorCriterion itemSelectorCriterion,
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/edition/item-selector/edition-item-selector.jsp");
