...
public class HelpRequestUtil {
	...
	public static List<HelpRequest> findByHelpProposalId(
		...
		return getPersistence().findByHelpProposalId(
			helpProposalId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(HelpRequestPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile HelpRequestPersistence _persistence;
