package eu.strasbourg.portlet.interest.util;
 ...
 * @author BMA
 */
public class InterestActionDropdownItemsProvider {

    public InterestActionDropdownItemsProvider(
            Interest interest, RenderRequest request,
