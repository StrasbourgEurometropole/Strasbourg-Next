...
<div class="strasbourg-image-picker form-group">
	<p>
		<label>
			...
			<span class="taglib-icon-help lfr-portal-tooltip" data-title="<liferay-ui:message key="eu.image-picker-help" />">
			    <span class="">
			        <svg class="lexicon-icon lexicon-icon-question-circle-full" role="img" title="<liferay-ui:message key="eu.image-picker-help" />" viewBox="0 0 512 512">
