 ...
 */
@ProviderType
public interface ActivityCourseSchedulePersistence
	extends BasePersistence<ActivityCourseSchedule> {
	 ...
	 */
	public java.util.List<ActivityCourseSchedule> findByUuid(String uuid);
	...
	public java.util.List<ActivityCourseSchedule> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ActivityCourseSchedule>
			orderByComparator);
	 ...
	 * @return the range of matching activity course schedules
	 */
	public java.util.List<ActivityCourseSchedule> findByGroupId(
