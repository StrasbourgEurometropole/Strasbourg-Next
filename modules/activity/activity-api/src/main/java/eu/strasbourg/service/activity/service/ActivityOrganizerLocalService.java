...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.activity.model.ActivityOrganizer"
	}
)
@ProviderType
@Transactional(
...
public interface ActivityOrganizerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.activity.service.impl.ActivityOrganizerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the activity organizer local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ActivityOrganizerLocalServiceUtil} if injection and service tracking are not available.
	 */
