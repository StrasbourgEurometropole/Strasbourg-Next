...
public interface PracticePersistence extends BasePersistence<Practice> {
	 ...
	 */
	public java.util.List<Practice> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Practice> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Practice> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Practice>
			orderByComparator);
	 ...
	 * @return the matching practices
	 */
	public java.util.List<Practice> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching practices
	 */
	public java.util.List<Practice> findByUuid_C(
	 ...
	 * @return the range of matching practices
	 */
	public java.util.List<Practice> findByAssociation(
	 ...
	 * @return the range of matching practices
	 */
	public java.util.List<Practice> findByGroupId(
