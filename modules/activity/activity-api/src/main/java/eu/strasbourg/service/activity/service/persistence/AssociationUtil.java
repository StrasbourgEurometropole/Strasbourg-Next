...
public class AssociationUtil {
	 ...
	 */
	public static Map<Serializable, Association> fetchByPrimaryKeys(
	 ...
	 */
	public static Association update(
		Association association, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Association> findByUuid(String uuid) {
	 ...
	 */
	public static List<Association> findByUuid(
	 ...
	 */
	public static Association findByUuid_First(
	 ...
	 */
	public static Association fetchByUuid_First(
		String uuid, OrderByComparator<Association> orderByComparator) {
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByUuid_Last(
			String uuid, OrderByComparator<Association> orderByComparator)
		throws eu.strasbourg.service.activity.exception.
			NoSuchAssociationException {
	 ...
	 */
	public static Association fetchByUuid_Last(
		String uuid, OrderByComparator<Association> orderByComparator) {
	 ...
	 */
	public static Association[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			associationId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByUUID_G(String uuid, long groupId)
		throws eu.strasbourg.service.activity.exception.
			NoSuchAssociationException {
	 ...
	 */
	public static Association fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching association, or <code>null</code> if a matching association could not be found
	 */
	public static Association fetchByUUID_G(
	 ...
	 */
	public static Association removeByUUID_G(String uuid, long groupId)
		throws eu.strasbourg.service.activity.exception.
			NoSuchAssociationException {
	 ...
	 * @return the matching associations
	 */
	public static List<Association> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching associations
	 */
	public static List<Association> findByUuid_C(
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByUuid_C_First(
	 ...
	 * @return the first matching association, or <code>null</code> if a matching association could not be found
	 */
	public static Association fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Association> orderByComparator) {
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Association> orderByComparator)
		throws eu.strasbourg.service.activity.exception.
			NoSuchAssociationException {
	 ...
	 * @return the last matching association, or <code>null</code> if a matching association could not be found
	 */
	public static Association fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Association> orderByComparator) {
	 ...
	 * @throws NoSuchAssociationException if a association with the primary key could not be found
	 */
	public static Association[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			associationId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the range of matching associations
	 */
	public static List<Association> findByGroupId(
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByGroupId_First(
	 ...
	 * @return the first matching association, or <code>null</code> if a matching association could not be found
	 */
	public static Association fetchByGroupId_First(
		long groupId, OrderByComparator<Association> orderByComparator) {
	 ...
	 * @throws NoSuchAssociationException if a matching association could not be found
	 */
	public static Association findByGroupId_Last(
			long groupId, OrderByComparator<Association> orderByComparator)
		throws eu.strasbourg.service.activity.exception.
			NoSuchAssociationException {
	 ...
	 * @return the last matching association, or <code>null</code> if a matching association could not be found
	 */
	public static Association fetchByGroupId_Last(
		long groupId, OrderByComparator<Association> orderByComparator) {
	 ...
	 * @throws NoSuchAssociationException if a association with the primary key could not be found
	 */
	public static Association[] findByGroupId_PrevAndNext(
		...
		return getPersistence().findByGroupId_PrevAndNext(
			associationId, groupId, orderByComparator);
	}
	...
	public static void setPersistence(AssociationPersistence persistence) {
