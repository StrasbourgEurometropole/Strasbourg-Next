...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.activity.model.Association"
	}
)
@ProviderType
@Transactional(
...
public interface AssociationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.activity.service.impl.AssociationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the association local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AssociationLocalServiceUtil} if injection and service tracking are not available.
	 */
