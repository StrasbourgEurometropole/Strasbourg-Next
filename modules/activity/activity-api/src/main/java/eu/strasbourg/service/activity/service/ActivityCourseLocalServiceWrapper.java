...
public class ActivityCourseLocalServiceWrapper
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
		createActivityCourse(long activityCourseId) {

		return _activityCourseLocalService.createActivityCourse(
			activityCourseId);
	}
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
			deleteActivityCourse(long activityCourseId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _activityCourseLocalService.deleteActivityCourse(
			activityCourseId);
	}
	...
	public long dynamicQueryCount(
		...
		return _activityCourseLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
		fetchActivityCourse(long activityCourseId) {

		return _activityCourseLocalService.fetchActivityCourse(
			activityCourseId);
	}
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
		fetchActivityCourseByUuidAndGroupId(String uuid, long groupId) {

		return _activityCourseLocalService.fetchActivityCourseByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List<eu.strasbourg.service.activity.model.ActivityCourse>
		findByIds(java.util.List<Long> activityCourseIds) {
	...
	public java.util.List<eu.strasbourg.service.activity.model.ActivityCourse>
		...
		return _activityCourseLocalService.findByKeyword(
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
			getActivityCourse(long activityCourseId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
			getActivityCourseByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _activityCourseLocalService.getActivityCourseByUuidAndGroupId(
			uuid, groupId);
	}
	...
	@Override
	public java.util.List<eu.strasbourg.service.activity.model.ActivityCourse>
		getActivityCourses(int start, int end) {
	...
	@Override
	public java.util.List<eu.strasbourg.service.activity.model.ActivityCourse>
		getActivityCoursesByUuidAndCompanyId(String uuid, long companyId) {

		return _activityCourseLocalService.getActivityCoursesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	@Override
	public java.util.List<eu.strasbourg.service.activity.model.ActivityCourse>
		getActivityCoursesByUuidAndCompanyId(
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _activityCourseLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	@Override
	public eu.strasbourg.service.activity.model.ActivityCourse
			removeActivityCourse(long activityCourseId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _activityCourseLocalService.removeActivityCourse(
			activityCourseId);
	}
	...
	public eu.strasbourg.service.activity.model.ActivityCourse
		...
		return _activityCourseLocalService.updateActivityCourse(
			activityCourse, sc);
	}
	...
	public eu.strasbourg.service.activity.model.ActivityCourse updateStatus(
		...
		return _activityCourseLocalService.updateStatus(
			userId, entryId, status);
	}

	@Override
	public BasePersistence<?> getBasePersistence() {
		return _activityCourseLocalService.getBasePersistence();
	}
