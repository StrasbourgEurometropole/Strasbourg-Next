 ...
 */
@ProviderType
public interface ActivityOrganizerPersistence
	extends BasePersistence<ActivityOrganizer> {
	 ...
	 */
	public java.util.List<ActivityOrganizer> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<ActivityOrganizer> findByUuid(
	...
	public java.util.List<ActivityOrganizer> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ActivityOrganizer>
			orderByComparator);
	 ...
	 * @return the range of matching activity organizers
	 */
	public java.util.List<ActivityOrganizer> findByGroupId(
