 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.AssociationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.activity.service.impl.AssociationServiceImpl
 * @generated
 */
public abstract class AssociationServiceBaseImpl
	extends BaseServiceImpl
	implements AssociationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssociationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AssociationServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(associationService);
	}
	...
	private void _setServiceUtilService(AssociationService associationService) {
		try {
			Field field = AssociationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, associationService);
		}
	...
	@BeanReference(type = AssociationService.class)
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssociationServiceBaseImpl.class);
