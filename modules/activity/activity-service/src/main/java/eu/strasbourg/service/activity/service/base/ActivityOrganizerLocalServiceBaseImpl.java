...
public abstract class ActivityOrganizerLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ActivityOrganizerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ActivityOrganizerLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return activityOrganizerPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return activityOrganizerPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ActivityOrganizerLocalServiceImpl#deleteActivityOrganizer(ActivityOrganizer) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<ActivityOrganizer> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(activityOrganizerLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ActivityOrganizerLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, activityOrganizerLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ActivityOrganizerLocalServiceBaseImpl.class);
