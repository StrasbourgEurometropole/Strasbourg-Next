...
import eu.strasbourg.service.activity.service.ActivityCoursePlaceService;
import eu.strasbourg.service.activity.service.ActivityCoursePlaceServiceUtil;
...
/**
 * Provides the base implementation for the activity course place remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.ActivityCoursePlaceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.activity.service.impl.ActivityCoursePlaceServiceImpl
 * @generated
 */
public abstract class ActivityCoursePlaceServiceBaseImpl
	extends BaseServiceImpl
	implements ActivityCoursePlaceService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ActivityCoursePlaceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ActivityCoursePlaceServiceUtil</code>.
	 */
	 ...
	 */
	public ActivityCoursePlaceService getActivityCoursePlaceService() {
	 ...
	 */
	public eu.strasbourg.service.activity.service.ActivityCourseScheduleService
		getActivityCourseScheduleService() {
	...
	public void setActivityCourseScheduleService(
		eu.strasbourg.service.activity.service.ActivityCourseScheduleService
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(activityCoursePlaceService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ActivityCoursePlaceService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ActivityCoursePlaceServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, activityCoursePlaceService);
		}
	...
	@BeanReference(type = ActivityCoursePlaceService.class)
	protected ActivityCoursePlaceService activityCoursePlaceService;
	...
	@BeanReference(
		type = eu.strasbourg.service.activity.service.ActivityCourseScheduleService.class
	)
	protected
		eu.strasbourg.service.activity.service.ActivityCourseScheduleService
			activityCourseScheduleService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ActivityCoursePlaceServiceBaseImpl.class);
