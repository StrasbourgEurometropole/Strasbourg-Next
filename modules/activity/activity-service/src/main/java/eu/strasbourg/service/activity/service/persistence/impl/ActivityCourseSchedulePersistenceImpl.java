...
public class ActivityCourseSchedulePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setActivityCourseScheduleUtilPersistence(this);
	}

	public void destroy() {
		_setActivityCourseScheduleUtilPersistence(null);

		entityCache.removeCache(ActivityCourseScheduleImpl.class.getName());
	}

	private void _setActivityCourseScheduleUtilPersistence(
		ActivityCourseSchedulePersistence activityCourseSchedulePersistence) {

		try {
			Field field = ActivityCourseScheduleUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, activityCourseSchedulePersistence);
		}
