...
import eu.strasbourg.service.activity.service.ActivityService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.ActivityServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ActivityServiceBaseImpl
	extends BaseServiceImpl
	implements ActivityService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ActivityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ActivityServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(activityService);
	}
	...
	private void _setServiceUtilService(ActivityService activityService) {
		try {
			Field field = ActivityServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, activityService);
		}
