 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.ActivityLocalServiceImpl}.
 * </p>
 *
...
public abstract class ActivityLocalServiceBaseImpl
	...
	implements ActivityLocalService, IdentifiableOSGiService {
	...
	public Activity fetchActivityByUuidAndGroupId(String uuid, long groupId) {
		return activityPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public List<Activity> getActivitiesByUuidAndCompanyId(
		...
		return activityPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Activity> getActivitiesByUuidAndCompanyId(
		...
		return activityPersistence.findByUuid_C(
	...
	public Activity getActivityByUuidAndGroupId(String uuid, long groupId)
		...
		return activityPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void afterPropertiesSet() {
		ActivityLocalServiceUtil.setService(activityLocalService);
	}

	public void destroy() {
		ActivityLocalServiceUtil.setService(null);
	}
