...
/**
 * Provides the base implementation for the practice local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.PracticeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PracticeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, PracticeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PracticeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PracticeLocalServiceUtil</code>.
	 */
	...
	public Practice addPractice(Practice practice) {
		...
		return practicePersistence.update(practice);
	}
	...
	public Practice createPractice(long practiceId) {
		return practicePersistence.create(practiceId);
	}
	...
	public Practice deletePractice(long practiceId) throws PortalException {
		return practicePersistence.remove(practiceId);
	}
	...
	public Practice deletePractice(Practice practice) {
		return practicePersistence.remove(practice);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return practicePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Practice.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return practicePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return practicePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Practice fetchPractice(long practiceId) {
		return practicePersistence.fetchByPrimaryKey(practiceId);
	}
	...
	public Practice fetchPracticeByUuidAndGroupId(String uuid, long groupId) {
		return practicePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Practice getPractice(long practiceId) throws PortalException {
		return practicePersistence.findByPrimaryKey(practiceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(practiceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Practice.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("practiceId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Practice.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("practiceId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Practice>() {
				...
				@Override
				public void performAction(Practice practice)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, practice);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return practicePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PracticeLocalServiceImpl#deletePractice(Practice) to avoid orphaned data");
		}

		return practiceLocalService.deletePractice((Practice)persistedModel);
	}

	@Override
	public BasePersistence<Practice> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return practicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Practice> getPracticesByUuidAndCompanyId(
		...
		return practicePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Practice> getPracticesByUuidAndCompanyId(
		...
		return practicePersistence.findByUuid_C(
	...
	public Practice getPracticeByUuidAndGroupId(String uuid, long groupId)
		...
		return practicePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Practice> getPractices(int start, int end) {
		return practicePersistence.findAll(start, end);
	}
	...
	public int getPracticesCount() {
		return practicePersistence.countAll();
	}
	 ...
	 */
	public PracticeLocalService getPracticeLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(practiceLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PracticeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = practicePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PracticeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, practiceLocalService);
		}
	...
	@BeanReference(type = PracticeLocalService.class)
	protected PracticeLocalService practiceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PracticeLocalServiceBaseImpl.class);
