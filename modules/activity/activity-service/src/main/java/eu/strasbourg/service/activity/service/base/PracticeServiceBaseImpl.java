...
import eu.strasbourg.service.activity.service.PracticeService;
import eu.strasbourg.service.activity.service.PracticeServiceUtil;
...
/**
 * Provides the base implementation for the practice remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.activity.service.impl.PracticeServiceImpl}.
 * </p>
 *
...
public abstract class PracticeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PracticeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PracticeServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(practiceService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PracticeService.class.getName();
	}
	...
	private void _setServiceUtilService(PracticeService practiceService) {
		try {
			Field field = PracticeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, practiceService);
		}
	...
	@BeanReference(type = PracticeService.class)
