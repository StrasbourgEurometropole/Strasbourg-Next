...
public class GalleryActionDropdownItemsProvider {
    public GalleryActionDropdownItemsProvider(VideoGallery gallery, RenderRequest request, RenderResponse _response) {
    ...
    public List<DropdownItem> getActionDropdownItems() {
        ...
        boolean hasUpdatePermission = _themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(), StrasbourgPortletKeys.VIDEO_BO, StrasbourgPortletKeys.VIDEO_BO, "EDIT_VIDEO_GALLERY") && Validator.isNull(_themeDisplay.getScopeGroup().getStagingGroup());

        boolean hasDeletePermission = _themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(), StrasbourgPortletKeys.VIDEO_BO, StrasbourgPortletKeys.VIDEO_BO, "DELETE_VIDEO_GALLERY") && Validator.isNull(_themeDisplay.getScopeGroup().getStagingGroup());
    ...
    private UnsafeConsumer<DropdownItem, Exception> _getEditActionUnsafeConsumer() {
        ...
        return dropdownItem -> {
            dropdownItem.setHref(PortletURLBuilder.createRenderURL(_response)
                    .setMVCPath("/video-bo-edit-gallery.jsp").setCMD("editGallery")
    ...
    private UnsafeConsumer<DropdownItem, Exception> _getDeleteActionUnsafeConsumer() {
        ...
        return dropdownItem -> {
            dropdownItem.setHref(PortletURLBuilder.createActionURL(_response)
                    .setActionName("deleteGallery").setMVCPath("/video-bo-view-galleries.jsp")
    ...
    private final VideoGallery _gallery;
