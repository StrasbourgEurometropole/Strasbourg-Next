...
public class ManagementGalleriesToolBarDisplayContext extends ManagementBaseToolBarDisplayContext<VideoGallery> {
    ...
    public ManagementGalleriesToolBarDisplayContext(
        ...
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                VideoGallery.class, searchContainer);
    ...
    protected boolean hasUpdatePermission() {
        return !WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(
                ...
                StrasbourgPortletKeys.VIDEO_BO, StrasbourgPortletKeys.VIDEO_BO, "EDIT_VIDEO_GALLERY")
    ...
    protected boolean hasDeletePermission() {
        return _themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.VIDEO_BO, StrasbourgPortletKeys.VIDEO_BO, "DELETE_VIDEO_GALLERY")
                && Validator.isNull(_themeDisplay.getScopeGroup().getStagingGroup());
    }
