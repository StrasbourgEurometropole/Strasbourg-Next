package eu.strasbourg.portlet.oidc.constants;

public class OidcConstants {

    public static final String PUBLIK_USERS = "publikUsers";
    ...
    public static final String EDIT_ANONYMISATION_HISTORIC = "editAnonymisationHistoric";
