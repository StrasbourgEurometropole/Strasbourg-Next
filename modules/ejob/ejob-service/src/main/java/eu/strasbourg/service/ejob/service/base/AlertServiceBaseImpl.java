...
import eu.strasbourg.service.ejob.service.AlertService;
...
/**
 * Provides the base implementation for the alert remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.ejob.service.impl.AlertServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.ejob.service.impl.AlertServiceImpl
 * @generated
 */
public abstract class AlertServiceBaseImpl
	extends BaseServiceImpl implements AlertService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AlertService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AlertServiceUtil</code>.
	 */
	...
	/**
	 * Returns the alert remote service.
	 *
	 * @return the alert remote service
	 */
	...
	/**
	 * Sets the alert remote service.
	 *
	 * @param alertService the alert remote service
	 */
	 ...
	 */
	public eu.strasbourg.service.ejob.service.OfferService getOfferService() {
		return offerService;
	}
	 ...
	 */
	public void setOfferService(
		eu.strasbourg.service.ejob.service.OfferService offerService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(alertService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AlertService.class.getName();
	}
	...
	private void _setServiceUtilService(AlertService alertService) {
		try {
			Field field = AlertServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, alertService);
		}
	...
	@BeanReference(type = AlertService.class)
	...
	@BeanReference(type = eu.strasbourg.service.ejob.service.OfferService.class)
	protected eu.strasbourg.service.ejob.service.OfferService offerService;
