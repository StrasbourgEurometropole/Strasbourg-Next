...
public class FoundObjectPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setFoundObjectUtilPersistence(this);
	}

	public void destroy() {
		_setFoundObjectUtilPersistence(null);

		entityCache.removeCache(FoundObjectImpl.class.getName());
	}

	private void _setFoundObjectUtilPersistence(
		FoundObjectPersistence foundObjectPersistence) {

		try {
			Field field = FoundObjectUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, foundObjectPersistence);
		}
