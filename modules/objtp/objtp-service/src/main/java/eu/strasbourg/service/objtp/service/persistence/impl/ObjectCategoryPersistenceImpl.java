...
public class ObjectCategoryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setObjectCategoryUtilPersistence(this);
	}

	public void destroy() {
		_setObjectCategoryUtilPersistence(null);

		entityCache.removeCache(ObjectCategoryImpl.class.getName());
	}

	private void _setObjectCategoryUtilPersistence(
		ObjectCategoryPersistence objectCategoryPersistence) {

		try {
			Field field = ObjectCategoryUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, objectCategoryPersistence);
		}
