 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.objtp.service.impl.ObjectCategoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ObjectCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ObjectCategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ObjectCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ObjectCategoryLocalServiceUtil</code>.
	 */
	...
	public ObjectCategory addObjectCategory(ObjectCategory objectCategory) {
		...
		return objectCategoryPersistence.update(objectCategory);
	}
	...
	public ObjectCategory createObjectCategory(String code) {
		return objectCategoryPersistence.create(code);
	}
	...
	public ObjectCategory deleteObjectCategory(String code)
		...
		return objectCategoryPersistence.remove(code);
	}
	...
	public ObjectCategory deleteObjectCategory(ObjectCategory objectCategory) {
		return objectCategoryPersistence.remove(objectCategory);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return objectCategoryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ObjectCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return objectCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return objectCategoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return objectCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return objectCategoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ObjectCategory fetchObjectCategory(String code) {
		return objectCategoryPersistence.fetchByPrimaryKey(code);
	}
	 ...
	 */
	@Override
	public ObjectCategory getObjectCategory(String code)
		throws PortalException {

		return objectCategoryPersistence.findByPrimaryKey(code);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return objectCategoryPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ObjectCategoryLocalServiceImpl#deleteObjectCategory(ObjectCategory) to avoid orphaned data");
		}

		return objectCategoryLocalService.deleteObjectCategory(
			(ObjectCategory)persistedModel);
	}

	@Override
	public BasePersistence<ObjectCategory> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return objectCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ObjectCategory> getObjectCategories(int start, int end) {
		return objectCategoryPersistence.findAll(start, end);
	}
	...
	public int getObjectCategoriesCount() {
		return objectCategoryPersistence.countAll();
	}
	 ...
	 */
	public ObjectCategoryLocalService getObjectCategoryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"eu.strasbourg.service.objtp.model.ObjectCategory",
			objectCategoryLocalService);

		_setLocalServiceUtilService(objectCategoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ObjectCategoryLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ObjectCategoryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, objectCategoryLocalService);
		}
	...
	@BeanReference(type = ObjectCategoryLocalService.class)
	protected ObjectCategoryLocalService objectCategoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ObjectCategoryLocalServiceBaseImpl.class);
