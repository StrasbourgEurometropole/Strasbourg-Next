...
public abstract class FoundObjectLocalServiceBaseImpl
	...
	implements FoundObjectLocalService, IdentifiableOSGiService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FoundObject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return foundObjectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return foundObjectPersistence.countWithDynamicQuery(
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(foundObjectLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FoundObjectLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, foundObjectLocalService);
		}
