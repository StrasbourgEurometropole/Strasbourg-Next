...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.objtp.model.ObjectCategory"
	}
)
@ProviderType
@Transactional(
...
public interface ObjectCategoryLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ObjectCategory deleteObjectCategory(String code)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectCategory fetchObjectCategory(String code);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectCategory getObjectCategory(String code) throws PortalException;
