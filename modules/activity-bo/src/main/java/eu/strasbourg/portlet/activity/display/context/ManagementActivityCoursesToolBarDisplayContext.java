...
public class ManagementActivityCoursesToolBarDisplayContext extends ManagementBaseToolBarDisplayContext<ActivityCourse> {
    ...
    public ManagementActivityCoursesToolBarDisplayContext(
        ...
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                ActivityCourse.class, searchContainer);
