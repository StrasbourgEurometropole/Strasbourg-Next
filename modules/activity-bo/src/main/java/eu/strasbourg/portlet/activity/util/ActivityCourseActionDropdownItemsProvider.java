 ...
 * @author AZC
 */
public class ActivityCourseActionDropdownItemsProvider {

    public ActivityCourseActionDropdownItemsProvider(
            ActivityCourse activityCourse, RenderRequest request,
    ...
    public List<DropdownItem> getActionDropdownItems() {
        ...
        boolean hasUpdatePermission = _themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.ACTIVITY_BO, StrasbourgPortletKeys.ACTIVITY_BO, "EDIT_ACTIVITY_COURSE")
        ...
        boolean hasDeletePermission = _themeDisplay.getPermissionChecker().hasPermission(this._themeDisplay.getScopeGroupId(),
                StrasbourgPortletKeys.ACTIVITY_BO, StrasbourgPortletKeys.ACTIVITY_BO, "DELETE_ACTIVITY_COURSE")
                && Validator.isNull(_themeDisplay.getScopeGroup().getStagingGroup());
        ...
        return dropdownItem -> {
            dropdownItem.setHref(
                    PortletURLBuilder.createRenderURL(_response)
                            .setMVCPath("/activity-bo-edit-course.jsp")
                            .setCMD("editActivityCourse")
                            .setBackURL(_themeDisplay.getURLCurrent())
                            .setParameter("tab", "activityCourses")
                            .setParameter("activityCourseId", _activityCourse.getActivityCourseId())
                            .buildString()
            );
        ...
        return dropdownItem -> {
            dropdownItem.setHref(
                    PortletURLBuilder.createActionURL(_response)
                            .setActionName("deleteActivityCourse")
