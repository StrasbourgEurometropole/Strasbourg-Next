...
/**
 * Provides the local service interface for PublicHoliday. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Angelique Zunino Champougny
 * @see PublicHolidayLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.place.model.PublicHoliday"
	}
)
@ProviderType
@Transactional(
...
public interface PublicHolidayLocalService
	 ...
	 */
	public PublicHoliday createPublicHoliday(ServiceContext sc)
		throws PortalException;
