...
/**
 * The persistence utility for the price service. This utility wraps <code>eu.strasbourg.service.place.service.persistence.impl.PricePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PriceUtil {
	 ...
	 */
	public static Map<Serializable, Price> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Price> findWithDynamicQuery(
	 ...
	 */
	public static List<Price> findByUuid(String uuid) {
	 ...
	 */
	public static List<Price> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Price> findByUuid(
	 ...
	 */
	public static Price findByUuid_First(
	 ...
	 */
	public static Price fetchByUuid_First(
		String uuid, OrderByComparator<Price> orderByComparator) {
	 ...
	 * @throws NoSuchPriceException if a matching price could not be found
	 */
	public static Price findByUuid_Last(
			String uuid, OrderByComparator<Price> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchPriceException {
	 ...
	 */
	public static Price fetchByUuid_Last(
		String uuid, OrderByComparator<Price> orderByComparator) {
	 ...
	 */
	public static Price[] findByUuid_PrevAndNext(
			long priceId, String uuid,
			OrderByComparator<Price> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchPriceException {

		return getPersistence().findByUuid_PrevAndNext(
			priceId, uuid, orderByComparator);
	}
	...
	public static void setPersistence(PricePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile PricePersistence _persistence;
