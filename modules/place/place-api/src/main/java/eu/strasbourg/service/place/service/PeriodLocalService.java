 ...
 */
@OSGiBeanProperties(
	property = {"model.class.name=eu.strasbourg.service.place.model.Period"}
)
@ProviderType
@Transactional(
...
public interface PeriodLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.place.service.impl.PeriodLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the period local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PeriodLocalServiceUtil} if injection and service tracking are not available.
	 */
