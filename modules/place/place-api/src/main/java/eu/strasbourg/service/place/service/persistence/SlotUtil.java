...
/**
 * The persistence utility for the slot service. This utility wraps <code>eu.strasbourg.service.place.service.persistence.impl.SlotPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SlotUtil {
	 ...
	 */
	public static Map<Serializable, Slot> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Slot> findWithDynamicQuery(
	 ...
	 */
	public static List<Slot> findByUuid(String uuid) {
	 ...
	 */
	public static List<Slot> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Slot> findByUuid(
	 ...
	 */
	public static Slot findByUuid_First(
	 ...
	 */
	public static Slot fetchByUuid_First(
		String uuid, OrderByComparator<Slot> orderByComparator) {
	 ...
	 * @throws NoSuchSlotException if a matching slot could not be found
	 */
	public static Slot findByUuid_Last(
			String uuid, OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {
	 ...
	 */
	public static Slot fetchByUuid_Last(
		String uuid, OrderByComparator<Slot> orderByComparator) {
	 ...
	 * @return the ordered range of matching slots
	 */
	public static List<Slot> findByPeriodId(
		long periodId, int start, int end,
		OrderByComparator<Slot> orderByComparator) {

		return getPersistence().findByPeriodId(
			periodId, start, end, orderByComparator);
	}
	...
	public static List<Slot> findByPeriodId(
		...
		return getPersistence().findByPeriodId(
			periodId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchSlotException if a matching slot could not be found
	 */
	public static Slot findByPeriodId_First(
			long periodId, OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findByPeriodId_First(
			periodId, orderByComparator);
	}
	 ...
	 * @return the first matching slot, or <code>null</code> if a matching slot could not be found
	 */
	public static Slot fetchByPeriodId_First(
		long periodId, OrderByComparator<Slot> orderByComparator) {

		return getPersistence().fetchByPeriodId_First(
			periodId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSlotException if a matching slot could not be found
	 */
	public static Slot findByPeriodId_Last(
			long periodId, OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findByPeriodId_Last(
			periodId, orderByComparator);
	}
	 ...
	 * @return the last matching slot, or <code>null</code> if a matching slot could not be found
	 */
	public static Slot fetchByPeriodId_Last(
		long periodId, OrderByComparator<Slot> orderByComparator) {

		return getPersistence().fetchByPeriodId_Last(
			periodId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSlotException if a slot with the primary key could not be found
	 */
	public static Slot[] findByPeriodId_PrevAndNext(
			long slotId, long periodId,
			OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findByPeriodId_PrevAndNext(
			slotId, periodId, orderByComparator);
	}
	 ...
	 * @return the range of matching slots
	 */
	public static List<Slot> findBySubPlaceId(
	...
	public static List<Slot> findBySubPlaceId(
		...
		return getPersistence().findBySubPlaceId(
	...
	public static List<Slot> findBySubPlaceId(
		...
		return getPersistence().findBySubPlaceId(
			subPlaceId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchSlotException if a matching slot could not be found
	 */
	public static Slot findBySubPlaceId_First(
			long subPlaceId, OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findBySubPlaceId_First(
	 ...
	 * @return the first matching slot, or <code>null</code> if a matching slot could not be found
	 */
	public static Slot fetchBySubPlaceId_First(
		long subPlaceId, OrderByComparator<Slot> orderByComparator) {

		return getPersistence().fetchBySubPlaceId_First(
			subPlaceId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSlotException if a matching slot could not be found
	 */
	public static Slot findBySubPlaceId_Last(
			long subPlaceId, OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findBySubPlaceId_Last(
			subPlaceId, orderByComparator);
	}
	 ...
	 * @return the last matching slot, or <code>null</code> if a matching slot could not be found
	 */
	public static Slot fetchBySubPlaceId_Last(
		long subPlaceId, OrderByComparator<Slot> orderByComparator) {

		return getPersistence().fetchBySubPlaceId_Last(
			subPlaceId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSlotException if a slot with the primary key could not be found
	 */
	public static Slot[] findBySubPlaceId_PrevAndNext(
			long slotId, long subPlaceId,
			OrderByComparator<Slot> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchSlotException {

		return getPersistence().findBySubPlaceId_PrevAndNext(
			slotId, subPlaceId, orderByComparator);
	}
	...
	public static void setPersistence(SlotPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile SlotPersistence _persistence;
