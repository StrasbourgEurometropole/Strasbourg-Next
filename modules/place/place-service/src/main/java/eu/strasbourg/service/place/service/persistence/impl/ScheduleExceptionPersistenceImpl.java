...
public class ScheduleExceptionPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setScheduleExceptionUtilPersistence(this);
	}

	public void destroy() {
		_setScheduleExceptionUtilPersistence(null);

		entityCache.removeCache(ScheduleExceptionImpl.class.getName());
	}

	private void _setScheduleExceptionUtilPersistence(
		ScheduleExceptionPersistence scheduleExceptionPersistence) {

		try {
			Field field = ScheduleExceptionUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, scheduleExceptionPersistence);
		}
