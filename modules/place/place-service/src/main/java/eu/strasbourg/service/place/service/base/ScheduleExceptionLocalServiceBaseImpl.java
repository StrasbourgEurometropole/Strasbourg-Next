...
/**
 * Provides the base implementation for the schedule exception local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.place.service.impl.ScheduleExceptionLocalServiceImpl}.
 * </p>
 *
...
public abstract class ScheduleExceptionLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, ScheduleExceptionLocalService {
	...
	public ScheduleException fetchScheduleException(long exceptionId) {
		return scheduleExceptionPersistence.fetchByPrimaryKey(exceptionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("exceptionId");
	...
	public List<ScheduleException> getScheduleExceptions(int start, int end) {
		return scheduleExceptionPersistence.findAll(start, end);
	}
	...
	public int getScheduleExceptionsCount() {
		return scheduleExceptionPersistence.countAll();
	}
	 ...
	 */
	public ScheduleExceptionLocalService getScheduleExceptionLocalService() {
	...
	public void afterPropertiesSet() {
		ScheduleExceptionLocalServiceUtil.setService(
			scheduleExceptionLocalService);
	}

	public void destroy() {
		ScheduleExceptionLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ScheduleExceptionLocalService.class.getName();
	}
