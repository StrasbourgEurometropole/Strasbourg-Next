...
public class SubPlacePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setSubPlaceUtilPersistence(this);
	}

	public void destroy() {
		_setSubPlaceUtilPersistence(null);

		entityCache.removeCache(SubPlaceImpl.class.getName());
	}

	private void _setSubPlaceUtilPersistence(
		SubPlacePersistence subPlacePersistence) {

		try {
			Field field = SubPlaceUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, subPlacePersistence);
		}
