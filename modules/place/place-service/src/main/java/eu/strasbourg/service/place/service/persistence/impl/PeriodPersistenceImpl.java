...
public class PeriodPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setPeriodUtilPersistence(this);
	}

	public void destroy() {
		_setPeriodUtilPersistence(null);

		entityCache.removeCache(PeriodImpl.class.getName());
	}

	private void _setPeriodUtilPersistence(
		PeriodPersistence periodPersistence) {

		try {
			Field field = PeriodUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, periodPersistence);
		}
