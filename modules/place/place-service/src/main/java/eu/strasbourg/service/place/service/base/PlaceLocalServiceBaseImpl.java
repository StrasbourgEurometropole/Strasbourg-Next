...
/**
 * Provides the base implementation for the place local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.place.service.impl.PlaceLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlaceLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PlaceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PlaceLocalServiceUtil</code>.
	 */
	...
	public Place deletePlace(long placeId) throws PortalException {
		return placePersistence.remove(placeId);
	}
	...
	public Place deletePlace(Place place) {
		return placePersistence.remove(place);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return placePersistence.dslQuery(dslQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return placePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public Place fetchPlace(long placeId) {
		return placePersistence.fetchByPrimaryKey(placeId);
	}
	...
	public Place fetchPlaceByUuidAndGroupId(String uuid, long groupId) {
		return placePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Place getPlace(long placeId) throws PortalException {
		return placePersistence.findByPrimaryKey(placeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("placeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Place.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("placeId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return placePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PlaceLocalServiceImpl#deletePlace(Place) to avoid orphaned data");
		}
	...
	public List<Place> getPlaces(int start, int end) {
		return placePersistence.findAll(start, end);
	}
	...
	public int getPlacesCount() {
		return placePersistence.countAll();
	}
	 ...
	 */
	public PlaceLocalService getPlaceLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(placeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"eu.strasbourg.service.place.model.Place");
	...
	public String getOSGiServiceIdentifier() {
		return PlaceLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PlaceLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, placeLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PlaceLocalServiceBaseImpl.class);
