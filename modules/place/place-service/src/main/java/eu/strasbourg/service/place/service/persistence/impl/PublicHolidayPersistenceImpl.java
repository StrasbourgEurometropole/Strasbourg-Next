...
public class PublicHolidayPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setPublicHolidayUtilPersistence(this);
	}

	public void destroy() {
		_setPublicHolidayUtilPersistence(null);

		entityCache.removeCache(PublicHolidayImpl.class.getName());
	}

	private void _setPublicHolidayUtilPersistence(
		PublicHolidayPersistence publicHolidayPersistence) {

		try {
			Field field = PublicHolidayUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, publicHolidayPersistence);
		}
