package eu.strasbourg.portlet.agenda.csmap.constants;
...
public class CsmapBoAgendaConstants {
    ...
    public static final String EDIT_AGENDA_THEMATIQUE = "editAgendaThematique";
    public static final String SAVE_AGENDA_THEMATIQUE = "saveAgendaThematique";
