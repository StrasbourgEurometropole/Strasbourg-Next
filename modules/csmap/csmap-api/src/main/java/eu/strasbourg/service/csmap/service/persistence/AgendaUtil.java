...
public class AgendaUtil {
	...
	public static List<Agenda> findByIsPrincipal(
		...
		return getPersistence().findByIsPrincipal(
			isPrincipal, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(AgendaPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AgendaPersistence _persistence;
