...
public class CsmapCacheUtil {
	...
	public static CsmapCache fetchByCodeCache(
		long codeCache, boolean useFinderCache) {

		return getPersistence().fetchByCodeCache(codeCache, useFinderCache);
	}
	...
	public static void setPersistence(CsmapCachePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile CsmapCachePersistence _persistence;
