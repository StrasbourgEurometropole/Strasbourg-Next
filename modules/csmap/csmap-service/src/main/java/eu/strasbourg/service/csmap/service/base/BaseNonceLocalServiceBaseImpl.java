 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.csmap.service.impl.BaseNonceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.csmap.service.impl.BaseNonceLocalServiceImpl
 * @generated
 */
public abstract class BaseNonceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BaseNonceLocalService, IdentifiableOSGiService {
	...
	public BaseNonce createBaseNonce(long baseNonceId) {
		return baseNoncePersistence.create(baseNonceId);
	}
	...
	public BaseNonce deleteBaseNonce(long baseNonceId) throws PortalException {
		return baseNoncePersistence.remove(baseNonceId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BaseNonce.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return baseNoncePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return baseNoncePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return baseNoncePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return baseNoncePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BaseNonce fetchBaseNonce(long baseNonceId) {
		return baseNoncePersistence.fetchByPrimaryKey(baseNonceId);
	}
	...
	public BaseNonce getBaseNonce(long baseNonceId) throws PortalException {
		return baseNoncePersistence.findByPrimaryKey(baseNonceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(baseNonceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BaseNonce.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("baseNonceId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			baseNonceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BaseNonce.class);
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return baseNoncePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BaseNonce> getBaseNonces(int start, int end) {
		return baseNoncePersistence.findAll(start, end);
	}
	...
	public int getBaseNoncesCount() {
		return baseNoncePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BaseNonceLocalService.class, IdentifiableOSGiService.class,
	...
	public String getOSGiServiceIdentifier() {
		return BaseNonceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = baseNoncePersistence.getDataSource();
