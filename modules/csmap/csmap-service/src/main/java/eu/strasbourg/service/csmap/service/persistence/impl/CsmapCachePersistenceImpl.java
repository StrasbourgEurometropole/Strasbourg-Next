...
public class CsmapCachePersistenceImpl
	...
	public void activate() {
		...
		_setCsmapCacheUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setCsmapCacheUtilPersistence(null);

		dummyEntityCache.removeCache(CsmapCacheImpl.class.getName());
	}

	private void _setCsmapCacheUtilPersistence(
		CsmapCachePersistence csmapCachePersistence) {

		try {
			Field field = CsmapCacheUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, csmapCachePersistence);
		}
