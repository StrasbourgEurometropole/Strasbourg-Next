...
public abstract class PlaceCategoriesLocalServiceBaseImpl
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(placeCategoriesLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PlaceCategoriesLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, placeCategoriesLocalService);
		}
