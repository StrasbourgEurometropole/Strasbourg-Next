 ...
 * @generated
 */
public abstract class LinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, LinkLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LinkLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return linkPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Link.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return linkPersistence.findWithDynamicQuery(
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler =
							StagedModelDataHandlerRegistryUtil.
								getStagedModelDataHandler(Link.class.getName());
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return linkPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LinkLocalServiceImpl#deleteLink(Link) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Link> getBasePersistence() {
	...
	public List<Link> getLinksByUuidAndCompanyId(
		...
		return linkPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"eu.strasbourg.service.link.model.Link", linkLocalService);

		_setLocalServiceUtilService(linkLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = LinkLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, linkLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LinkLocalServiceBaseImpl.class);
