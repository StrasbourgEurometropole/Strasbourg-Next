...
public class LinkPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setLinkUtilPersistence(this);
	}

	public void destroy() {
		_setLinkUtilPersistence(null);

		entityCache.removeCache(LinkImpl.class.getName());
	}

	private void _setLinkUtilPersistence(LinkPersistence linkPersistence) {
		try {
			Field field = LinkUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, linkPersistence);
		}
