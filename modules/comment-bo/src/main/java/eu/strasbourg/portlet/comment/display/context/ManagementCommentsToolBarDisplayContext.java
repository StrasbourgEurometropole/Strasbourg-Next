...
public class ManagementCommentsToolBarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

    public ManagementCommentsToolBarDisplayContext(
            HttpServletRequest httpServletRequest,
            LiferayPortletRequest liferayPortletRequest,
            LiferayPortletResponse liferayPortletResponse,
            ViewCommentDisplayContext viewCommentDisplayContext) throws PortalException {
        super(httpServletRequest, liferayPortletRequest, liferayPortletResponse,
                viewCommentDisplayContext.getSearchContainer());
        _viewCommentDisplayContext = viewCommentDisplayContext;
    ...
    /**
     * Get Comments Vocabularies
     */
    protected List<AssetVocabulary> getCommentVocabularies() {
        if(_vocabularies == null) {
            ThemeDisplay themeDisplay =
                    (ThemeDisplay) httpServletRequest.getAttribute(
                            WebKeys.THEME_DISPLAY);
            long companyGroupId = themeDisplay.getCompanyGroupId();
            long classNameId = ClassNameLocalServiceUtil.getClassNameId(Comment.class);
    ...
    private final ViewCommentDisplayContext _viewCommentDisplayContext;
