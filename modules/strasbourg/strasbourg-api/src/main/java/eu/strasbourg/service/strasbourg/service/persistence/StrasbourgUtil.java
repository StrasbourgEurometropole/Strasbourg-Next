...
/**
 * The persistence utility for the strasbourg service. This utility wraps <code>eu.strasbourg.service.strasbourg.service.persistence.impl.StrasbourgPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StrasbourgUtil {
	 ...
	 */
	public static Map<Serializable, Strasbourg> fetchByPrimaryKeys(
	 ...
	 */
	public static Strasbourg update(
		Strasbourg strasbourg, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Strasbourg> findByUuid(String uuid) {
	 ...
	 */
	public static List<Strasbourg> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Strasbourg> findByUuid(
	 ...
	 */
	public static Strasbourg findByUuid_First(
			String uuid, OrderByComparator<Strasbourg> orderByComparator)
		throws eu.strasbourg.service.strasbourg.exception.
			NoSuchStrasbourgException {
	 ...
	 */
	public static Strasbourg fetchByUuid_First(
		String uuid, OrderByComparator<Strasbourg> orderByComparator) {
	 ...
	 * @throws NoSuchStrasbourgException if a matching strasbourg could not be found
	 */
	public static Strasbourg findByUuid_Last(
			String uuid, OrderByComparator<Strasbourg> orderByComparator)
		throws eu.strasbourg.service.strasbourg.exception.
			NoSuchStrasbourgException {
	 ...
	 */
	public static Strasbourg fetchByUuid_Last(
		String uuid, OrderByComparator<Strasbourg> orderByComparator) {
	 ...
	 */
	public static Strasbourg[] findByUuid_PrevAndNext(
			long id, String uuid,
			OrderByComparator<Strasbourg> orderByComparator)
		throws eu.strasbourg.service.strasbourg.exception.
			NoSuchStrasbourgException {
	...
	public static void setPersistence(StrasbourgPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile StrasbourgPersistence _persistence;
