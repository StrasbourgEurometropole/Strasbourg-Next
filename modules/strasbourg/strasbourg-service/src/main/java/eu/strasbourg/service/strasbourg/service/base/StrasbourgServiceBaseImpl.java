...
public abstract class StrasbourgServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StrasbourgService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StrasbourgServiceUtil</code>.
	 */
	 ...
	 */
	public eu.strasbourg.service.strasbourg.service.StrasbourgLocalService
		getStrasbourgLocalService() {
	...
	public void setStrasbourgLocalService(
		eu.strasbourg.service.strasbourg.service.StrasbourgLocalService
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(strasbourgService);
	}
	...
	private void _setServiceUtilService(StrasbourgService strasbourgService) {
		try {
			Field field = StrasbourgServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, strasbourgService);
		}
	...
	@BeanReference(
		type = eu.strasbourg.service.strasbourg.service.StrasbourgLocalService.class
	)
	protected eu.strasbourg.service.strasbourg.service.StrasbourgLocalService
		strasbourgLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		StrasbourgServiceBaseImpl.class);
