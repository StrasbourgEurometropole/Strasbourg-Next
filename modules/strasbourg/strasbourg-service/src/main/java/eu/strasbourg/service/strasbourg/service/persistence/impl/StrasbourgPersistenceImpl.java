...
public class StrasbourgPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setStrasbourgUtilPersistence(this);
	}

	public void destroy() {
		_setStrasbourgUtilPersistence(null);

		entityCache.removeCache(StrasbourgImpl.class.getName());
	}

	private void _setStrasbourgUtilPersistence(
		StrasbourgPersistence strasbourgPersistence) {

		try {
			Field field = StrasbourgUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, strasbourgPersistence);
		}
