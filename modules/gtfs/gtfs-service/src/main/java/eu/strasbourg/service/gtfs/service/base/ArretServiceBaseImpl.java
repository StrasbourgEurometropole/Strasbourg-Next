 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.gtfs.service.impl.ArretServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class ArretServiceBaseImpl
	extends BaseServiceImpl implements ArretService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ArretService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ArretServiceUtil</code>.
	 */
	 ...
	 */
	public eu.strasbourg.service.gtfs.service.LigneService getLigneService() {
		return ligneService;
	}
	 ...
	 */
	public void setLigneService(
		eu.strasbourg.service.gtfs.service.LigneService ligneService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(arretService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ArretService.class.getName();
	}
	...
	private void _setServiceUtilService(ArretService arretService) {
		try {
			Field field = ArretServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, arretService);
		}
	...
	@BeanReference(type = ArretService.class)
	...
	@BeanReference(type = eu.strasbourg.service.gtfs.service.LigneService.class)
	protected eu.strasbourg.service.gtfs.service.LigneService ligneService;
