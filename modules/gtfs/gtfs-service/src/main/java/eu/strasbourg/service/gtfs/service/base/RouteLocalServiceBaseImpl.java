 ...
 * @generated
 */
public abstract class RouteLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RouteLocalService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Route.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return routePersistence.findWithDynamicQuery(
	...
	public void afterPropertiesSet() {
		RouteLocalServiceUtil.setService(routeLocalService);
	}

	public void destroy() {
		RouteLocalServiceUtil.setService(null);
	}
