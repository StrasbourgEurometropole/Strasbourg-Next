...
import eu.strasbourg.service.gtfs.service.CalendarDateLocalService;
...
/**
 * Provides the base implementation for the calendar date local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.gtfs.service.impl.CalendarDateLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
 ...
 * @generated
 */
public abstract class CalendarDateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CalendarDateLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CalendarDateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CalendarDateLocalServiceUtil</code>.
	 */
	...
	public CalendarDate addCalendarDate(CalendarDate calendarDate) {
		...
		return calendarDatePersistence.update(calendarDate);
	}
	...
	public CalendarDate createCalendarDate(long id) {
		return calendarDatePersistence.create(id);
	}
	...
	public CalendarDate deleteCalendarDate(long id) throws PortalException {
		return calendarDatePersistence.remove(id);
	}
	...
	public CalendarDate deleteCalendarDate(CalendarDate calendarDate) {
		return calendarDatePersistence.remove(calendarDate);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return calendarDatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CalendarDate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return calendarDatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return calendarDatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return calendarDatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return calendarDatePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CalendarDate fetchCalendarDate(long id) {
		return calendarDatePersistence.fetchByPrimaryKey(id);
	}
	...
	public CalendarDate getCalendarDate(long id) throws PortalException {
		return calendarDatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(calendarDateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CalendarDate.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CalendarDate.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return calendarDatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CalendarDateLocalServiceImpl#deleteCalendarDate(CalendarDate) to avoid orphaned data");
		}

		return calendarDateLocalService.deleteCalendarDate(
			(CalendarDate)persistedModel);
	}

	@Override
	public BasePersistence<CalendarDate> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return calendarDatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CalendarDate> getCalendarDates(int start, int end) {
		return calendarDatePersistence.findAll(start, end);
	}
	...
	public int getCalendarDatesCount() {
		return calendarDatePersistence.countAll();
	}
	 ...
	 */
	public CalendarDateLocalService getCalendarDateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"eu.strasbourg.service.gtfs.model.CalendarDate",
			calendarDateLocalService);

		_setLocalServiceUtilService(calendarDateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CalendarDateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = calendarDatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CalendarDateLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, calendarDateLocalService);
		}
	...
	@BeanReference(type = CalendarDateLocalService.class)
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CalendarDateLocalServiceBaseImpl.class);
