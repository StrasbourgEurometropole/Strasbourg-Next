...
public class LignePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setLigneUtilPersistence(this);
	}

	public void destroy() {
		_setLigneUtilPersistence(null);

		entityCache.removeCache(LigneImpl.class.getName());
	}

	private void _setLigneUtilPersistence(LignePersistence lignePersistence) {
		try {
			Field field = LigneUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, lignePersistence);
		}
