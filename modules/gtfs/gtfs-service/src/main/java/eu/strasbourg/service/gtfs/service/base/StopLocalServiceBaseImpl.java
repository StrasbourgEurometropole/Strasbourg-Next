 ...
 * @generated
 */
public abstract class StopLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, StopLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StopLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StopLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return stopPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Stop.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return stopPersistence.findWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return stopPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement StopLocalServiceImpl#deleteStop(Stop) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Stop> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"eu.strasbourg.service.gtfs.model.Stop", stopLocalService);

		_setLocalServiceUtilService(stopLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StopLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stopLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		StopLocalServiceBaseImpl.class);
