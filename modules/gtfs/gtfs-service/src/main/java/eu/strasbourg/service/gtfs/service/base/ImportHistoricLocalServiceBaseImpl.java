...
/**
 * Provides the base implementation for the import historic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.gtfs.service.impl.ImportHistoricLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
...
public abstract class ImportHistoricLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, ImportHistoricLocalService {
	...
	public ImportHistoric addImportHistoric(ImportHistoric importHistoric) {
		...
		return importHistoricPersistence.update(importHistoric);
	}
	...
	public ImportHistoric fetchImportHistoric(long importHistoricId) {
		return importHistoricPersistence.fetchByPrimaryKey(importHistoricId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("importHistoricId");
	...
	public List<ImportHistoric> getImportHistorics(int start, int end) {
		return importHistoricPersistence.findAll(start, end);
	}
	...
	public int getImportHistoricsCount() {
		return importHistoricPersistence.countAll();
	}
	 ...
	 */
	public ImportHistoricLocalService getImportHistoricLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return ImportHistoricLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = importHistoricPersistence.getDataSource();
