...
public class ImportHistoricPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setImportHistoricUtilPersistence(this);
	}

	public void destroy() {
		_setImportHistoricUtilPersistence(null);

		entityCache.removeCache(ImportHistoricImpl.class.getName());
	}

	private void _setImportHistoricUtilPersistence(
		ImportHistoricPersistence importHistoricPersistence) {

		try {
			Field field = ImportHistoricUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, importHistoricPersistence);
		}
