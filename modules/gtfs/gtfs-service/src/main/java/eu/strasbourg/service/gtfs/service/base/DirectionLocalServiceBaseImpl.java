...
import eu.strasbourg.service.gtfs.service.DirectionLocalService;
...
/**
 * Provides the base implementation for the direction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.gtfs.service.impl.DirectionLocalServiceImpl}.
 * </p>
 *
 * @author Cedric Henry
...
public abstract class DirectionLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DirectionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DirectionLocalServiceUtil</code>.
	 */
	...
	public Direction addDirection(Direction direction) {
		...
		return directionPersistence.update(direction);
	}
	...
	public Direction deleteDirection(Direction direction) {
		return directionPersistence.remove(direction);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return directionPersistence.dslQuery(dslQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return directionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public Direction fetchDirection(long directionId) {
		return directionPersistence.fetchByPrimaryKey(directionId);
	}
	...
	public Direction fetchDirectionByUuidAndGroupId(String uuid, long groupId) {
		return directionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Direction getDirection(long directionId) throws PortalException {
		return directionPersistence.findByPrimaryKey(directionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("directionId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return directionPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DirectionLocalServiceImpl#deleteDirection(Direction) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Direction> getBasePersistence() {
	...
	public List<Direction> getDirections(int start, int end) {
		return directionPersistence.findAll(start, end);
	}
	...
	public int getDirectionsCount() {
		return directionPersistence.countAll();
	}
	 ...
	 */
	public DirectionLocalService getDirectionLocalService() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(directionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DirectionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = directionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DirectionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, directionLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DirectionLocalServiceBaseImpl.class);
