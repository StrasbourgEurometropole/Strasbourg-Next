...
public class RouteUtil {
	...
	public static Route fetchByRouteId(
		String route_id, boolean useFinderCache) {

		return getPersistence().fetchByRouteId(route_id, useFinderCache);
	}
	...
	public static void setPersistence(RoutePersistence persistence) {
