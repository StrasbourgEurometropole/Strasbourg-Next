...
public class StopUtil {
	 ...
	 */
	public static List<Stop> findByUuid(String uuid) {
	 ...
	 */
	public static List<Stop> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Stop> findByUuid(
	 ...
	 */
	public static Stop findByUuid_First(
	 ...
	 */
	public static Stop fetchByUuid_First(
		String uuid, OrderByComparator<Stop> orderByComparator) {
	 ...
	 * @throws NoSuchStopException if a matching stop could not be found
	 */
	public static Stop findByUuid_Last(
			String uuid, OrderByComparator<Stop> orderByComparator)
		throws eu.strasbourg.service.gtfs.exception.NoSuchStopException {
	 ...
	 */
	public static Stop fetchByUuid_Last(
		String uuid, OrderByComparator<Stop> orderByComparator) {
	 ...
	 * @return the matching stop, or <code>null</code> if a matching stop could not be found
	 */
	public static Stop fetchByStopId(String stop_id, boolean useFinderCache) {
		return getPersistence().fetchByStopId(stop_id, useFinderCache);
	}
	...
	public static List<Stop> findByStopCode(
		...
		return getPersistence().findByStopCode(
			stop_code, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(StopPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile StopPersistence _persistence;
