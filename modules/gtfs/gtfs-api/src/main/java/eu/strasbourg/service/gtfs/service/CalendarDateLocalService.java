...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.gtfs.model.CalendarDate"
	}
)
@ProviderType
@Transactional(
...
public interface CalendarDateLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.gtfs.service.impl.CalendarDateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the calendar date local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CalendarDateLocalServiceUtil} if injection and service tracking are not available.
	 */
