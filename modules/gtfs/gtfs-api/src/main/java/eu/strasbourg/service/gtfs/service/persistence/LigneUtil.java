...
public class LigneUtil {
	 ...
	 * @return the matching ligne, or <code>null</code> if a matching ligne could not be found
	 */
	public static Ligne fetchByRouteId(String routeId, boolean useFinderCache) {
		return getPersistence().fetchByRouteId(routeId, useFinderCache);
	}
	 ...
	 * @return the matching lignes
	 */
	public static List<Ligne> findByStatus(int status) {
	 ...
	 * @return the range of matching lignes
	 */
	public static List<Ligne> findByStatus(int status, int start, int end) {
	 ...
	 * @return the ordered range of matching lignes
	 */
	public static List<Ligne> findByStatus(
	 ...
	 * @throws NoSuchLigneException if a matching ligne could not be found
	 */
	public static Ligne findByStatus_First(
	 ...
	 * @return the first matching ligne, or <code>null</code> if a matching ligne could not be found
	 */
	public static Ligne fetchByStatus_First(
		int status, OrderByComparator<Ligne> orderByComparator) {
	 ...
	 * @throws NoSuchLigneException if a matching ligne could not be found
	 */
	public static Ligne findByStatus_Last(
			int status, OrderByComparator<Ligne> orderByComparator)
		throws eu.strasbourg.service.gtfs.exception.NoSuchLigneException {
	 ...
	 * @return the last matching ligne, or <code>null</code> if a matching ligne could not be found
	 */
	public static Ligne fetchByStatus_Last(
		int status, OrderByComparator<Ligne> orderByComparator) {
	 ...
	 * @throws NoSuchLigneException if a ligne with the primary key could not be found
	 */
	public static Ligne[] findByStatus_PrevAndNext(
			long ligneId, int status,
			OrderByComparator<Ligne> orderByComparator)
		throws eu.strasbourg.service.gtfs.exception.NoSuchLigneException {

		return getPersistence().findByStatus_PrevAndNext(
			ligneId, status, orderByComparator);
	}
	...
	public static List<Ligne> findByShortNameAndStatus(
		...
		return getPersistence().findByShortNameAndStatus(
			shortName, status, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(LignePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile LignePersistence _persistence;
