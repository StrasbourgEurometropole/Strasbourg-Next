...
@OSGiBeanProperties(
	property = {
		"model.class.name=eu.strasbourg.service.gtfs.model.CacheAlertJSON"
	}
)
@ProviderType
@Transactional(
...
public interface CacheAlertJSONLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>eu.strasbourg.service.gtfs.service.impl.CacheAlertJSONLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cache alert json local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CacheAlertJSONLocalServiceUtil} if injection and service tracking are not available.
	 */
