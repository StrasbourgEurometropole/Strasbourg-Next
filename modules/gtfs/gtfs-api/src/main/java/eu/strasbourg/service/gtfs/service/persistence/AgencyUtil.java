...
/**
 * The persistence utility for the agency service. This utility wraps <code>eu.strasbourg.service.gtfs.service.persistence.impl.AgencyPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AgencyUtil {
	 ...
	 */
	public static Map<Serializable, Agency> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Agency> findWithDynamicQuery(
	 ...
	 */
	public static List<Agency> findByUuid(String uuid) {
	 ...
	 */
	public static List<Agency> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Agency> findByUuid(
	 ...
	 */
	public static Agency findByUuid_First(
	 ...
	 */
	public static Agency fetchByUuid_First(
		String uuid, OrderByComparator<Agency> orderByComparator) {
	 ...
	 * @throws NoSuchAgencyException if a matching agency could not be found
	 */
	public static Agency findByUuid_Last(
			String uuid, OrderByComparator<Agency> orderByComparator)
		throws eu.strasbourg.service.gtfs.exception.NoSuchAgencyException {
	 ...
	 */
	public static Agency fetchByUuid_Last(
		String uuid, OrderByComparator<Agency> orderByComparator) {
	 ...
	 */
	public static Agency[] findByUuid_PrevAndNext(
	...
	public static void setPersistence(AgencyPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AgencyPersistence _persistence;
