 ...
 */
@ProviderType
public interface ImportHistoricPersistence
	extends BasePersistence<ImportHistoric> {
	 ...
	 */
	public java.util.List<ImportHistoric> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<ImportHistoric> findByUuid(
	...
	public java.util.List<ImportHistoric> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ImportHistoric>
			orderByComparator);
	 ...
	 * @return the matching import historics
	 */
	public java.util.List<ImportHistoric> findByUuid_C(
	 ...
	 * @return the range of matching import historics
	 */
	public java.util.List<ImportHistoric> findByGroupId(
