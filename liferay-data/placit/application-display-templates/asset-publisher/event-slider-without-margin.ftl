								...
								<div>
									<div class="pro-header-event">
										...
										<h3 style="display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;
											overflow: hidden;text-overflow: ellipsis;height: 80px">
											${entry.getTitle(locale)}
										</h3>
										<span class="prefix-location">${entry.getPlaceAlias(locale)}</span>
									</div>
									<div class="pro-footer-event">
										<span class="pro-number">
											<strong>${entry.getNbEventParticipations()}</strong> Participant(s)
										</span>
										<#if entry.isFinished() >
