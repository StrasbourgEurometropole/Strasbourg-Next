        ...
        <div class="ops-wrapper-header">
            ...
            <div class="ops-header-right">
                <ul class="ops-social">
                    ...
                    <li><a href="https://www.youtube.com/channel/UCZ4sbEP0KBZClyCSRjJWV8Q" title="<@liferay_ui.message key='eu.ops.link.to.youtube' />" target="_blank" aria-label="Page Youtube" >
