...
/* min ready */
/* Ajout de la condition sur id!=='' pour afficher l'id des scripts, car il renvoi un id='' qui n'est pas accessible sans ça. (ligne 1921) */
/* Suppression du role, car il n'existe pas. (lignes 434 et 455) */
...
var tarteaucitron = {
    ...
    "addFrame": function (frame_title, url, allowfullscreen, srcdoc = "", loading = "") {
        return '<iframe title="' + frame_title + '" type="text/html" src="' + url + '"' + (allowfullscreen == '0' ? '' : ' allowfullscreen') + ' ' + srcdoc + ' ' + loading + '></iframe>';
    },
    "load": function () {
        "use strict";
